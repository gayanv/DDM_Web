 ...
 * @author Dinesh
 */
public class ReportSubTypeDAOImpl implements ReportSubTypeDAO
{
    ...
    public ReportSubType getReportType(String reportTypeID)
    {
        ...
        try
        {
            ...
            lt = ReportSubTypeUtil.makeReportTypeObject(rs);
    ...
    {
        Collection<ReportSubType> col = null;
        Connection con = null;
        PreparedStatement pstm = null;
        ResultSet rs = null;
        ...
        try
        {
            ...
            col = ReportSubTypeUtil.makeReportTypeObjectsCollection(rs);
