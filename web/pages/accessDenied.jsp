...
<%
    ...
    if (session_userName != null)
    {
        ...
        fromPage = (String) request.getParameter("fp");

        if (msg == null && fromPage != null)
        {
            DAOFactory.getLogDAO().addLog(new Log(DDM_Constants.log_type_user_access_denied, "| Unauthorized access to page - 'LankaPay Direct Debit Mandate Exchange System - " + fromPage + " ' | Accessed By - " + session_userName + " (" + session_userTypeDesc + ") |"));
        }
...
<html>
    <head>
        <title>LankaPay Direct Debit Mandate Exchange System - Access Denied</title>
                                        ...
                                        <td><table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" >
                                                ...
                                                <tr>
                                                  ...
                                                  <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
                                                            ...
                                                            <tr>
                                                                <td height="100" align="center" valign="middle" class="ddm_special_msg_text">Access Denied!</td>
                                                    </tr>
                                                            <tr>
...
<%
    ...
    {
        //DAOFactory.getUserDAO().updateUserVisitStat(userName, DDM_Constants.status_no);
