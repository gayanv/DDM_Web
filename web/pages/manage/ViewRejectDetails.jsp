...
<%
    ...
    totalRecordCount = DAOFactory.getOWDetailsDAO().getRecordCountOWDetails(fileID, bDate, DDM_Constants.status_all, DDM_Constants.ddm_transaction_status_09);

    System.out.print("totalRejectedRecordCount ---> " + totalRecordCount);

    if (totalRecordCount < DDM_Constants.noPageRecords)
    {
        colResult = DAOFactory.getOWDetailsDAO().getOWDetails(fileID, bDate, DDM_Constants.status_all, DDM_Constants.ddm_transaction_status_09);

        DAOFactory.getLogDAO().addLog(new Log(DDM_Constants.log_type_user_confirm_on_uploaded_ddm_view_reject_transactions, "| File Id - " + fileID + " | Record Count - " + colResult.size() + ", Total Record Count - " + totalRecordCount + " | Viewed By - " + session_userName + " (" + session_userTypeDesc + ") |"));
    }
    else
    {
        DAOFactory.getLogDAO().addLog(new Log(DDM_Constants.log_type_user_confirm_on_uploaded_ddm_view_reject_transactions, "| File Id - " + fileID + " | Record Count - " + totalRecordCount + ", Total Record Count - " + totalRecordCount + " | Viewed By - " + session_userName + " (" + session_userTypeDesc + ") |"));
    }
                                                                ...
                                                                <td align="center" valign="middle"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="left" valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                    <tr>
                                                                                        <td width="15">&nbsp;</td>
                                                                                        <td align="left" valign="top" class="ddm_header_text"> View Reject Transaction Details - (File : <%=fileID%>)</td>
                                                                                        <td width="15">&nbsp;</td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td height="20"></td>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td align="center" valign="top">
                                                                                            ...
                                                                                            <table border="0" cellspacing="0" cellpadding="0" >
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td align="center" class="ddm_error" height="100"></td>
                                                                                                </tr>

                                                                                                <tr>
                                                                                                    <td align="center" class="ddm_error">Sorry! Details view prevented due to too many records. (Max Viewable Records Count - <%=DDM_Constants.noPageRecords%> , Current Records Count - <%=totalRecordCount %>, This can be lead to memory overflow in your machine.)</td>
                                                                                                </tr>
