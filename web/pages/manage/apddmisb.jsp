...
<%
    ...
    else
    {
        ...
        if (!isAccessOK)
        {
            if (DAOFactory.getLogDAO().addLog(new Log(DDM_Constants.log_type_user_access_denied, "| Unauthorized access to page - 'LankaPay Direct Debit Mandate Exchange System - New DDM Request(s) Issuing Bank Approval' | Accessed By - " + session_userName + " (" + session_userTypeDesc + ") |")))
            {
                response.sendRedirect(request.getContextPath() + "/pages/accessDenied.jsp");
            }
            else
            {
                response.sendRedirect(request.getContextPath() + "/pages/accessDenied.jsp?fp=New_DDM_Requests_Issuing_Bank_Approval");
            }
        }
        else
        {
...
<%
    ...
    else
    {
        ...
        else if (isSearchReq.equals("1"))
        {
            ...
            colDDMRequestDetails = DAOFactory.getDDMRequestDAO().getDDARequestDetailsForIssuingBankApproval(issuingBankCode, issuingBranchCode, acquiringBankCode, acquiringBranchCode, selMerchant);

            DAOFactory.getLogDAO().addLog(new Log(DDM_Constants.log_type_user_ddm_request_issuing_bank_approval_search, "| Search Criteria - (Issuing Bank : " + issuingBankCode + ", Issuing Branch : " + issuingBranchCode + ", Acquiring Bank : " + acquiringBankCode + ", Acquiring Branch : " + acquiringBranchCode + ", Merchant : " + selMerchant + ", DDM Request Date : From - " + fromBusinessDate + "  To - " + toBusinessDate + ") | Result Count - " + (colDDMRequestDetails != null ? colDDMRequestDetails.size() : "0") + " | Searched By - " + session_userName + " (" + session_userTypeDesc + ") |"));
        }
    }
...
<html>
    <head>
        <title>LankaPay Direct Debit Mandate Exchange System - New DDM Request(s) Issuing Bank Approval</title>
        ...
        <script language="JavaScript" type="text/javascript">
            ...
            function doSubmit()
            {
                document.frmApproveDDMR_Search.action = "apddmisb.jsp";
                                                                ...
                                                                <td align="center" valign="middle"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="left" valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                    ...
                                                                                    <tr>
                                                                                        <td></td>
                                                                                        <td align="center" valign="top"><form name="frmApproveDDMR_Search" id="frmApproveDDMR_Search" method="post" >
                                                                                                                    ...
                                                                                                                    <td align="center" valign="top" ><table border="0" cellspacing="1" cellpadding="4">
                                                                                                                            <tr>
                                                                                                                                ...
                                                                                                                                <td align="left" valign="middle" class="ddm_tbl_common_text" ><%
                                                                                                                                    ...
                                                                                                                                    %>
                                                                                                                                    <select name="cmbIssuingBank" id="cmbIssuingBank" class="ddm_field_border"  onChange="isSearchRequest(false);
                                                                                                                                                    doSubmit();"  <%=!(session_userType.equals(DDM_Constants.user_type_ddm_manager) || session_userType.equals(DDM_Constants.user_type_ddm_supervisor)) ? "disabled" : ""%>>
                                                                                                                                        <%
                                                                                                                            ...
                                                                                                                            <tr>
                                                                                                                                ...
                                                                                                                                <td align="left" valign="middle" class="ddm_tbl_common_text"><%                                                                                                                        try
                                                                                                                                    ...
                                                                                                                                    %>
                                                                                                                                    <select name="cmbAcquiringBank" class="ddm_field_border" id="cmbAcquiringBank" onChange="isSearchRequest(false);
                                                                                                                                            doSubmit();"  >
                                                                                            ...
                                                                                            <form name="frmApproveDDMR" id="frmApproveDDMR" method="post" action="conapddmisb.jsp" >
