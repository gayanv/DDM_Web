...
//    System.out.println("cbrIdListRejected###" + cbrIdListRejected);
    try
    {
        ...
        curDDMR_Stat = DDM_Constants.ddm_request_status_04;
        newDDMR_Stat = DDM_Constants.ddm_request_status_05;
        newDDMR_StatRejected = DDM_Constants.ddm_request_status_12;
                                                                ...
                                                                <td align="center" valign="middle"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="left" valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                                                    ...
                                                                                                                    <table border="0" cellspacing="1" cellpadding="3"  bgcolor="#FFFFFF" >
                                                                                                                        ...
                                                                                                                        <tr bgcolor="<%=rowNum % 2 == 0 ? "#E8E8EA" : "#F9F9F9"%>"   onMouseOver="cOn(this)" onMouseOut="cOut(this)">
                                                                                                                            ...
                                                                                                                            <td class="ddm_common_text"><span class="ddm_common_text" title="<%=ddmrSuccess.getStatusDesc()%>"><%=ddmrSuccess.getStatusDesc()%></span></td>
                                                                                                                                <%
                                                                                                                                    String strRemarks = ddmrSuccess.getAcquiringBankAcceptedRemarks();

                                                                                                                                %>

                                                                                                                            <td class="ddm_common_text"><%=(strRemarks != null) ? strRemarks : ""%></td>
                                                                                                                            <%
                                                                                                                                String strBy = ddmrSuccess.getAcquiringBankAcceptedBy();
                                                                                                                            ...
                                                                                                                            <%
                                                                                                                                String strTime = ddmrSuccess.getAcquiringBankAcceptedOn();
                                                                                                                    ...
                                                                                                                    <table border="0" cellspacing="1" cellpadding="3"  bgcolor="#FFFFFF" >
                                                                                                                        ...
                                                                                                                        <tr bgcolor="<%=rowNum % 2 == 0 ? "#E8E8EA" : "#F9F9F9"%>"   onMouseOver="cOn(this)" onMouseOut="cOut(this)">
                                                                                                                            ...
                                                                                                                            <td align="center" class="ddm_common_text"><span class="ddm_common_text" title="<%=ddmrUnsuccess.getStatusDesc()%>"><%=ddmrUnsuccess.getStatus()%></span></td>
                                                                                                                                <%
                                                                                                                                    String strRemarks = ddmrUnsuccess.getAcquiringBankAcceptedRemarks();

                                                                                                                                %>

                                                                                                                            <td class="ddm_common_text"><%=(strRemarks != null) ? strRemarks : ""%></td>
                                                                                                                            <%
                                                                                                                                String strBy = ddmrUnsuccess.getAcquiringBankAcceptedBy();
                                                                                                                            ...
                                                                                                                            <%
                                                                                                                                String strTime = ddmrUnsuccess.getAcquiringBankAcceptedOn();
                                                                                    ...
                                                                                    <tr>
                                                                                        <td></td>
                                                                                        <td align="center" valign="top"><a href="apddmacb.jsp" target="_self"><input name="btnBack" id="btnBack" value="&nbsp;&nbsp; Back &nbsp;&nbsp;" type="button" class="ddm_custom_button" /></a></td>
                                                                                        <td></td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td></td>
