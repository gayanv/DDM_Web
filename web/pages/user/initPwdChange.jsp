    ...
    else if (isChangeReq.equals("1"))
    {
        ...
        if (result)
        {
            ...
            if (pwdHisUpdateStat)
            {
                ...
                DAOFactory.getLogDAO().addLog(new Log(DDM_Constants.log_type_user_init_password_reset, "| Initial Password Change | Username - " + userName + ") | Process Status - Success | Done By - " + userName + " (" + userTypeDesc + ") |"));
            ...
            else
            {
                ...
                DAOFactory.getLogDAO().addLog(new Log(DDM_Constants.log_type_user_init_password_reset, "| Initial Password Change | Username - " + userName + ") | Process Status - Unsuccess update password history (" + msg + ") | Done By - " + userName + " (" + userTypeDesc + ") |"));
        ...
        {
            msg = userDAO.getMsg();
            DAOFactory.getLogDAO().addLog(new Log(DDM_Constants.log_type_user_init_password_reset, "| Initial Password Reset | Username - " + userName + ") | Process Status - Unsuccess (" + msg + ") | Done By - " + userName + " (" + userTypeDesc + ") |"));
...
<html>
    <head>
        <title>LankaPay Direct Debit Mandate Exchange System - Change Initial / Reset Password</title>
    ...
    <body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad="setAnimLights()">
...
<div class="bg bg3"></div>
        ...
        <form method="post" name="frmChangeInitPwd" onSubmit="return validate()">
            ...
            <div class="ddm_loginbox"> 
                ...
                <span class="ddm_error_ipwd_change_large"><u>Please change your initial / reset password.</u></span>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="1">
                    ...
                    <tr>
                        <td height="15" valign="top" class="ddm_error_ipwd_change">
                            Note : The new password should not be equal to last  <%=iMinPwdHistory%> password(s) you used, must be a combination of alpha numeric and at least one special character with minimum of 8 characters in length!
