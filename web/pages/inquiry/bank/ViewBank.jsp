...
<%
    ...
    if (bankStatus != null)
    {
        ...
        DAOFactory.getLogDAO().addLog(new Log(DDM_Constants.log_type_user_inquiry_view_bank_details, "| Search Criteria - (Bank Status : " + bankStatusDesc + ") | Result Count - " + col_bank.size() + " | Viewed By - " + session_userName + " (" + session_userTypeDesc + ") |"));
    }
    else
    {
        col_bank = DAOFactory.getBankDAO().getBank(DDM_Constants.status_all);
        DAOFactory.getLogDAO().addLog(new Log(DDM_Constants.log_type_user_inquiry_view_bank_details, "| Search Criteria - (Bank Status : All) | Result Count - " + col_bank.size() + " | Viewed By - " + session_userName + " (" + session_userTypeDesc + ") |"));
    }
%>


<html>
    <head><title>LankaPay Direct Debit Mandate Exchange System - View Bank</title>
                                                                                                                ...
                                                                                                                <td align="center" valign="middle">
                                                                                                                    ...
                                                                                                                    <form name="frmBankFilter" method="post" action="ViewBank.jsp">
                                                                                                                        ...
                                                                                                                        <table  border="0" cellspacing="1" cellpadding="3" class="ddm_table_boder" bgcolor="#FFFFFF" align="center">
                                                                                                                            <tr>
                                                                                                                                <td width="80" align="right" valign="middle" class="ddm_tbl_header_text"> Bank Status :</td>
                                                                                                                                <td width="" align="left" valign="middle" class="ddm_tbl_common_text">
                                                                                                                                    <table  border="0" cellpadding="0" cellspacing="0" >
                                                                                                                                        <tr>
                                                                                                                                            ...
                                                                                                                                            <td width="5"></td>
                                                                                                                                            <td class="ddm_common_text_bold">All</td>
                                                                                                                                            <td width="15"></td>
                                                                                                                                            ...
                                                                                                                                            <td width="5"></td>
                                                                                                                                            <td class="ddm_common_text_bold">Active</td>
                                                                                                                                            <td width="15"></td>
                                                                                                                                            ...
                                                                                                                                            <td width="5"></td>
                                                                                                                                            <td class="ddm_common_text_bold">Deactive</td>
                                                                                                                                        </tr>
                                                                                                                                    </table>
                                                                                                                                </td>
                                                                                                                            </tr>
                                                                                                    ...
                                                                                                    <td align="center" valign="middle">
                                                                                                        <table border="0" cellspacing="1" cellpadding="3" class="ddm_table_boder" bgcolor="#FFFFFF">
                                                                                                            <tr>
                                                                                                                ...
                                                                                                                <td align="center" valign="middle" class="ddm_tbl_header_text_horizontal">Bank Code</td>
                                                                                                                <td align="center" valign="middle" class="ddm_tbl_header_text_horizontal">Short Name</td>
                                                                                                                <td align="center" valign="middle" class="ddm_tbl_header_text_horizontal">Full Name</td>
                                                                                                            ...
                                                                                                            <tr bgcolor="<%=rowNum % 2 == 0 ? "#E8E8EA" : "#F9F9F9"%>"   onMouseOver="cOn(this)" onMouseOut="cOut(this)">
                                                                                                                ...
                                                                                                                <td align="center" bgcolor="<%=rowNum % 2 == 0 ? "#E8E8EA" : "#F9F9F9"%>"  class="ddm_common_text"><%=b.getBankCode() != null ? b.getBankCode() : "N/A"%></td>
                                                                                                                <td align="center" bgcolor="<%=rowNum % 2 == 0 ? "#E8E8EA" : "#F9F9F9"%>"  class="ddm_common_text"><%=b.getShortName() != null ? b.getShortName() : "N/A"%></td>
                                                                                                                <td align="left" bgcolor="<%=rowNum % 2 == 0 ? "#E8E8EA" : "#F9F9F9"%>"  class="ddm_common_text"><%=b.getBankFullName() != null ? b.getBankFullName() : "N/A"%></td>
                                                                                                                <td align="center" bgcolor="<%=rowNum % 2 == 0 ? "#E8E8EA" : "#F9F9F9"%>"  class="ddm_common_text"><%=b.getStatus() != null ? b.getStatus().equals(DDM_Constants.status_active) ? "Active" : "De-Active" : "N/A"%></td>
                                                                                                            </tr>
                                                                                                            <%
                                                                                                                }
