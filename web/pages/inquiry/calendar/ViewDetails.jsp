...
<%
    ...
    else if (isSearchReq.equals("1"))
    {
        ...
        DAOFactory.getLogDAO().addLog(new Log(DDM_Constants.log_type_user_inquiry_view_cealring_calendar_details, "| Search Criteria - (Year : " + year + " Month : " + month + " Day : " + day + " Type : " + type + ") | Result Count - " + colCalendar.size() + " | Viewed By - " + session_userName + " (" + session_userTypeDesc + ") |"));
    }
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td align="center" valign="top" >
                                                                                                            ...
                                                                                                            <table border="0" cellpadding="3" cellspacing="1" bgcolor="#FFFFFF" >
                                                                                                                <tr>
                                                                                                                    <td align="right" valign="middle" class="ddm_tbl_header_text" > Year :</td>
                                                                                                                    <td align="left" valign="middle" class="ddm_tbl_common_text" ><%
                                                                                                                        try
                                                                                                                        {
                                                                                                                        %>
                                                                                                                        <select name="cmbYear" id="cmbYear" onChange="isSearchRequest(false)" class="ddm_field_border" >
                                                                                                                        ...
                                                                                                                        %>                                                                                            </td>
                                                                                                                    <td align="right" valign="middle" class="ddm_tbl_header_text">Month  :</td>
                                                                                                                    ...
                                                                                                                    <td align="right" valign="middle" class="ddm_tbl_header_text" >Day :</td>
                                                                                                                    <td align="left" valign="middle" class="ddm_tbl_common_text" ><select name="cmbDay" id="cmbDay" class="ddm_field_border" onChange="clearResultData();">
                                                                                                                            <%%>
                                                                                                                    ...
                                                                                                                    <td align="right" valign="middle" class="ddm_tbl_header_text" >Type :</td>
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    <td colspan="8" align="right" valign="middle" bgcolor="#CDCDCD" class="ddm_tbl_footer_text" >
                                                                                                ...
                                                                                                <td> 
                                                                                                    ...
                                                                                                    <div id="resultdata">
                                                                                                        <table border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#FFFFFF" class="ddm_table_boder">
                                                                                                            <tr align="center">
                                                                                                                <th class="ddm_tbl_header_text_horizontal"></th>

                                                                                                                <th class="ddm_tbl_header_text_horizontal">Date</th>
                                                                                                                <th class="ddm_tbl_header_text_horizontal">Day Name</th>
                                                                                                                <th class="ddm_tbl_header_text_horizontal">Type</th>
                                                                                                                    <%                                                                                            if (!session_userType.equals(DDM_Constants.user_type_bank_user))
                                                                                                                        {
                                                                                                                    %>
                                                                                                                <th class="ddm_tbl_header_text_horizontal">Category</th>
                                                                                                                    <%                                                                                            }
                                                                                                                    %>
                                                                                                                <th class="ddm_tbl_header_text_horizontal">Remarks</th>
                                                                                                                    <%
                                                                                                                        if (!session_userType.equals(DDM_Constants.user_type_bank_user))
                                                                                                                        {

                                                                                                                    %>
                                                                                                                <th class="ddm_tbl_header_text_horizontal">Last<br/>
                                                                                                                    Modified By</th>
                                                                                                                <th class="ddm_tbl_header_text_horizontal">Last<br/>
                                                                                                                    Modified Date</th>
                                                                                                                    <%                                                                                             }
                                                                                                            ...
                                                                                                            <tr bgcolor="<%=rowNum % 2 == 0 ? "#E8E8EA" : "#F9F9F9"%>"   onMouseOver="cOn(this)" onMouseOut="cOut(this)">
                                                                                                                ...
                                                                                                                <td align="center" class="ddm_common_text"><%=cal.getDay()%></td>
                                                                                                                ...
                                                                                                                %>
                                                                                                                <td align="center" class="ddm_common_text"><%=cal.getRemarks() == null || cal.getRemarks().length() <= 0 ? "N/A" : cal.getRemarks()%></td>
                                                                                                                <%
                                                                                                                    if (!session_userType.equals(DDM_Constants.user_type_bank_user))
                                                                                                                    {

                                                                                                                %>
                                                                                                                <td align="center" class="ddm_common_text"><%=cal.getModifiedby() == null || cal.getModifiedby().length() <= 0 ? "N/A" : cal.getModifiedby()%></td>
