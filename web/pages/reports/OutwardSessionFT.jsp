...
<%
    ...
    if (isSearchReq == null)
    {
        ...
        reportType = DDM_Constants.report_type_owd_ft_session;
    ...
    else if (isSearchReq.equals("1"))
    {
        ...
        String reportName = cmbBusinessDate.replaceAll("-", "") + "_S" + sessionID + "_" +DDM_Constants.report_owd_session_ft + DDM_Constants.file_ext_type_pdf;
...
<html>
    <head>
        <title>LankaPay Direct Debit Mandate Exchange System - Outward Fund Transfer Reports - Session-Wise</title>
                                                                ...
                                                                <td align="center" valign="middle"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="left" valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                    <tr>
                                                                                        <td width="10">&nbsp;</td>
                                                                                        <td align="left" valign="top" class="slips_header_text">Outward Fund Transfer Reports - Session-Wise</td>
                                                                                        <td width="10">&nbsp;</td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td height="15"></td>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td width="10"></td>
                                                                                        <td align="center" valign="top" class="slips_header_text"><form id="frmOWDSessionFT" name="frmOWDSessionFT" method="post" action="OutwardSessionFT.jsp">
                                                                                                                                ...
                                                                                                                                <td colspan="4" align="right" valign="middle" class="slips_tbl_footer_text">                                                                                                                                <table cellpadding="0" cellspacing="0" border="0">
                                                                                                                                        <tr>
                                                                                                                                            ...
                                                                                                                                            <td align="right"><input name="btnSearch" id="btnSearch" value="Generate" type="button" onClick="isSearchRequest(true);
                                                                                                                                                    frmOWDSessionFT.submit()"  class="slips_custom_button"/></td>
                                                                                                                                        </tr>
                                                                                                                                    </table></td>
                                                                                                                            </tr>
                                                                                                                        </table></td>
                                                                                        ...
                                                                                        <td align="center" valign="top"><table border="0" cellpadding="0" cellspacing="0">
                                                                                                <tr>
                                                                                                    <td><table border="0" cellpadding="0" cellspacing="0">
                                                                                                            ...
                                                                                                            <tr>
                                                                                                                <td align="center"><div id="noresultbanner" class="slips_Display_Error_msg">Error occurred while generating the Outward Fund Transfer Reports !</div></td>
                                                                                                            </tr>	
                                                                                                            ...
                                                                                                            <tr>
                                                                                                                <td align="center"><div id="noresultbanner" class="slips_Display_Error_msg">No records available to generate Outward Fund Transfer Reports!</div></td>
                                                                                                            </tr>
                                                                                                            <%   }
                                                                                                            else if (colResult.size() > 0)
                                                                                                            {
