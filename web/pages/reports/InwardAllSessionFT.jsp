...
<%
    ...
    if (isSearchReq == null)
    {
        ...
        reportType = DDM_Constants.report_type_iwd_ft_session_all;
    ...
    else if (isSearchReq.equals("1"))
    {
        ...
        String reportName = cmbBusinessDate.replaceAll("-", "") + "_" + DDM_Constants.report_iwd_all_session_ft + DDM_Constants.file_ext_type_pdf;
...
<html>
    <head>
        <title>LankaPay Direct Debit Mandate Exchange System - Inward Fund Transfer Reports - All Sessions</title>
                                                                ...
                                                                <td align="center" valign="middle"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="left" valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                    <tr>
                                                                                        <td width="10">&nbsp;</td>
                                                                                        <td align="left" valign="top" class="slips_header_text">Inward Fund Transfer Reports - All Sessions</td>
                                                                                        <td width="10">&nbsp;</td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td height="15"></td>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td width="10"></td>
                                                                                        <td align="center" valign="top" class="slips_header_text"><form id="frmIWDAllSessionFT" name="frmIWDAllSessionFT" method="post" action="InwardAllSessionFT.jsp">
                                                                                                                                ...
                                                                                                                                <td colspan="4" align="right" valign="middle" class="slips_tbl_footer_text">                                                                                                                                <table cellpadding="0" cellspacing="0" border="0">
                                                                                                                                        <tr>
                                                                                                                                            ...
                                                                                                                                            <td align="right"><input name="btnSearch" id="btnSearch" value="Generate" type="button" onClick="isSearchRequest(true);
                                                                                                                                                    frmIWDAllSessionFT.submit()"  class="slips_custom_button"/></td>
                                                                                                                                        </tr>
                                                                                                                                    </table></td>
                                                                                                                            </tr>
                                                                                                                        </table></td>
