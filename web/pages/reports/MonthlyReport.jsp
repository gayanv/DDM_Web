...
<%
    ...
    else
    {
        ...
        if (!isAccessOK)
        {
            ...
            {
                response.sendRedirect(request.getContextPath() + "/pages/accessDenied.jsp?fp=Monthly_Reports");
            }
        }
        else
        {
...
<%
    ...
    if (isSearchReq == null)
    {
        ...
        if (!(session_userType.equals(DDM_Constants.user_type_ddm_manager) || session_userType.equals(DDM_Constants.user_type_ddm_supervisor) || session_userType.equals(DDM_Constants.user_type_ddm_helpdesk_user) || session_userType.equals(DDM_Constants.user_type_ddm_operator)))
        {
            ...
            reportType = DDM_Constants.report_type_bank_monthly;
    ...
    else if (isSearchReq.equals("1"))
    {
        ...
        colResult = DAOFactory.getReportDAO().getReportDetails(selectedBankCode, DDM_Constants.status_all, selectedMerchant, reportType, DDM_Constants.report_type_monthly, DDM_Constants.status_yes, fromBusinessDate, toBusinessDate);

        DAOFactory.getLogDAO().addLog(new Log(DDM_Constants.log_type_user_reports_view_monthly_reports, "| Search Criteria - (Bank : " + selectedBankCode + ", Merchant : " + selectedMerchant + ", Report Type : Monthly, From BusinessDate : " + fromBusinessDate + ", To BusinessDate : " + toBusinessDate + ") | Result Count - " + (colResult != null ? colResult.size() : "0") + " | Viewed By - " + session_userName + " (" + session_userTypeDesc + ") |"));
    }
%>
<html>
    <head>
        <title>LankaPay Direct Debit Mandate Exchange System - Monthly Reports</title>
                                                                ...
                                                                <td align="center" valign="middle"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="left" valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                    <tr>
                                                                                        <td width="10">&nbsp;</td>
                                                                                        <td align="left" valign="top" class="ddm_header_text">Monthly Reports</td>
                                                                                        <td width="10">&nbsp;</td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td height="15"></td>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td width="10"></td>
                                                                                        <td align="center" valign="top" class="ddm_header_text"><form id="frmSearchMonthlyReports" name="frmSearchMonthlyReports" method="post" action="MonthlyReport.jsp">
                                                                                                        ...
                                                                                                        <td><table border="0" cellspacing="1" cellpadding="4">
                                                                                                                <tr>
                                                                                                                    ...
                                                                                                                    <td align="left" valign="middle" class="ddm_tbl_common_text"><%
                                                                                                                        ...
                                                                                                                        {
                                                                                                                        %>
                                                                                                                        <select name="cmbBank" id="cmbBank" onChange="isSearchRequest(false);frmSearchMonthlyReports.submit()" class="ddm_field_border" <%=(session_userType.equals(DDM_Constants.user_type_bank_manager) || session_userType.equals(DDM_Constants.user_type_bank_user) || session_userType.equals(DDM_Constants.user_type_merchant_su) || session_userType.equals(DDM_Constants.user_type_merchant_op)) ? "disabled" : ""%>>
                                                                                                                            <%
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    ...
                                                                                                                    <td colspan="2" align="right" valign="middle" class="ddm_tbl_footer_text"><table cellpadding="0" cellspacing="0" border="0">
                                                                                                                            <tr>
                                                                                                                                ...
                                                                                                                                <td width="5"></td>
                                                                                                                                <td align="right"><input name="btnSearch" id="btnSearch" value="&nbsp;&nbsp; Search &nbsp;&nbsp;" type="button" onClick="isSearchRequest(true);frmSearchMonthlyReports.submit()"  class="ddm_custom_button"/></td>
                                                                                                                            </tr>
                                                                                                                        </table></td>
                                                                                                                </tr>
                                                                                                            </table></td>
