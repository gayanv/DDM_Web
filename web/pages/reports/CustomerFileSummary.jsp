...
<%
    ...
    if (isSearchReq == null)
    {
        ...
        reportType = DDM_Constants.report_type_cfws_summary;
    ...
    {
        reportType = DDM_Constants.report_type_cfws_summary;
        sessionID = (String) request.getParameter("cmbSession");
    ...
    else if (isSearchReq.equals("1"))
    {
        ...
        if (session_userType.equals(DDM_Constants.user_type_slips_manager) || session_userType.equals(DDM_Constants.user_type_slips_supervisor))
        {
            String reportName = cmbBusinessDate.replaceAll("-", "") + "_S" + sessionID + "_" + DDM_Constants.report_customer_file_wise_session_summary + DDM_Constants.file_ext_type_pdf;

            System.out.println("1. Customer File-Wise Session Summary Report ------> " + reportName);

            String url = DAOFactory.getReportDAO().generateCustomerSummary_Reports(cmbBusinessDate, sessionID, reportType, reportName, session_userName);
            ...
            if (url != null && !url.isEmpty())
            {
                ...
                colResult = DAOFactory.getReportDAO().getReportDetails(DDM_Constants.default_bank_code, DDM_Constants.default_branch_code, DDM_Constants.status_all, sessionID, reportType, DDM_Constants.status_yes, cmbBusinessDate, cmbBusinessDate);
            }
            else
            {
                colResult = null;
        ...
        else if (session_userType.equals(DDM_Constants.user_type_slips_administrator) || session_userType.equals(DDM_Constants.user_type_slips_helpdesk_user))
        {
            colResult = DAOFactory.getReportDAO().getReportDetails(DDM_Constants.default_bank_code, DDM_Constants.default_branch_code, DDM_Constants.status_all, sessionID, reportType, DDM_Constants.status_yes, cmbBusinessDate, cmbBusinessDate);
        }
        ...
        {
            String reportName = cmbBusinessDate.replaceAll("-", "") + "_S" + sessionID + "_B" + session_branchId + "_" + DDM_Constants.report_customer_file_wise_session_wise_branch_summary + "_" + session_branchId + DDM_Constants.file_ext_type_pdf;

            System.out.println("2. Customer File-Wise Session Summary Report (Branch) ------> " + reportName);

            String url = DAOFactory.getReportDAO().generateCustomerSummary_Branch_Reports(cmbBusinessDate, sessionID, session_branchId, reportType, reportName, session_userName);

            if (url != null && !url.isEmpty())
            {
                DAOFactory.getReportDAO().addReportDetails(cmbBusinessDate, sessionID, DDM_Constants.default_bank_code, session_branchId, DDM_Constants.default_coporate_customer_id, reportName, url, reportType, session_userName);

                colResult = DAOFactory.getReportDAO().getReportDetails(DDM_Constants.default_bank_code, session_branchId, DDM_Constants.status_all, sessionID, reportType, DDM_Constants.status_yes, cmbBusinessDate, cmbBusinessDate);
            }
            else
            {
                colResult = null;
        ...
        {
            String reportName = cmbBusinessDate.replaceAll("-", "") + "_S" + sessionID + "_C" + session_cocuId + "_" + DDM_Constants.report_customer_file_wise_session_wise_cocu_summary + DDM_Constants.file_ext_type_pdf;

            System.out.println("3. Customer File-Wise Session Summary Report (CoCu) ------> " + reportName);

            String url = DAOFactory.getReportDAO().generateCustomerSummary_CoCu_Reports(cmbBusinessDate, sessionID, session_branchId, session_cocuId, reportType, reportName, session_userName);

            if (url != null && !url.isEmpty())
            {
                DAOFactory.getReportDAO().addReportDetails(cmbBusinessDate, sessionID, DDM_Constants.default_bank_code, session_branchId, session_cocuId, reportName, url, reportType, session_userName);

                colResult = DAOFactory.getReportDAO().getReportDetails(DDM_Constants.default_bank_code, session_branchId, session_cocuId, sessionID, reportType, DDM_Constants.status_yes, cmbBusinessDate, cmbBusinessDate);
            }
            else
            {
                colResult = null;
...
<html>
    <head>
        <title>LankaPay Direct Debit Mandate Exchange System - Customer File-Wise Session Summary Report</title>
                                                                ...
                                                                <td align="center" valign="middle"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="left" valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                    <tr>
                                                                                        <td width="10">&nbsp;</td>
                                                                                        <td align="left" valign="top" class="slips_header_text">Customer File-Wise Session Summary Report</td>
                                                                                        <td width="10">&nbsp;</td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td height="15"></td>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td width="10"></td>
                                                                                        <td align="center" valign="top" class="slips_header_text"><form id="frmCFWSSR" name="frmCFWSSR" method="post" action="CustomerFileSummary.jsp">
                                                                                                                    ...
                                                                                                                    <td align="center" valign="top" ><table border="0" cellspacing="1" cellpadding="3" >
                                                                                                                            <tr>
                                                                                                                                ...
                                                                                                                                <td align="left" valign="middle" class="slips_tbl_common_text"><%
                                                                                                                                    ...
                                                                                                                                    %>
                                                                                                                                    <select name="cmbSession" id="cmbSession"  class="slips_field_border" >

                                                                                                                                        <%                                                                                                                                            for (int i = 1; i <= noOfActiveSessions; i++)
                                                                                                                                            {

                                                                                                                                        %>
                                                                                                                                        <option value="<%=(i)%>" <%=(sessionID != null && sessionID.equals("" + i)) ? "selected" : ""%> >Session - <%=i%></option>
                                                                                                                                        <%
                                                                                                                            ...
                                                                                                                            <tr>
                                                                                                                                <td colspan="4" align="right" valign="middle" class="slips_tbl_footer_text">                                                                                                                                <table cellpadding="0" cellspacing="0" border="0">
                                                                                                                                        <tr>
                                                                                                                                            ...
                                                                                                                                            <td width="5"></td>
                                                                                                                                            <td align="right"><input name="btnSearch" id="btnSearch" value="<%=(session_userType.equals(DDM_Constants.user_type_slips_administrator) || session_userType.equals(DDM_Constants.user_type_slips_helpdesk_user)?"Search":"Generate")%>" type="button" onClick="isSearchRequest(true);
                                                                                                                                                            frmCFWSSR.submit()"  class="slips_custom_button"/></td>
                                                                                                                                        </tr>
                                                                                                                                    </table></td>
                                                                                                                            </tr>
                                                                                                                        </table></td>
                                                                                        ...
                                                                                        <td align="center" valign="top"><table border="0" cellpadding="0" cellspacing="0">
                                                                                                <tr>
                                                                                                    <td><table border="0" cellpadding="0" cellspacing="0">
                                                                                                            ...
                                                                                                            <tr>
                                                                                                                <td align="center"><div id="noresultbanner" class="slips_Display_Error_msg">Error occurred while generating the Customer File-Wise Session Summary Report !</div></td>
                                                                                                            </tr>	
                                                                                                            ...
                                                                                                            <tr>
                                                                                                                <td align="center"><div id="noresultbanner" class="slips_Display_Error_msg">No records available to generate Customer File-Wise Session Summary Report !</div></td>
                                                                                                            </tr>
                                                                                                            <%   }
                                                                                                            else if (colResult.size() > 0)
                                                                                                            {
