                                                                                            ...
                                                                                            <table border="0" cellpadding="0" cellspacing="0">
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td align="center" valign="middle">
                                                                                                        ...
                                                                                                        <form method="post" name="frmViewMoreDetails" id="frmViewMoreDetails" action="ViewMoreDetails.jsp" >
                                                                                                            <input name="hdnMerchantID" id="hdnMerchantID" type="hidden">
                                                                                                            <input name="hdnMerchantBank" id="hdnMerchantBank" type="hidden" value="<%=bankCode %>">
                                                                                                            <input name="hdnMerchantBranch" id="hdnMerchantBranch" type="hidden" value="<%=branchCode %>">
                                                                                                            <input name="hdnMerchantStatus" id="hdnMerchantStatus" type="hidden" value="<%=merchantStatus %>">
                                                                                                        </form>
