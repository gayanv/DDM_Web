...
<%
    ...
    else
    {
        ...
        {
            //session.invalidate();
            if (DAOFactory.getLogDAO().addLog(new Log(DDM_Constants.log_type_user_access_denied, "| Unauthorized access to page - 'LankaPay Direct Debit Mandate Exchange System - Authorize Activated User' | Accessed By - " + session_userName + " (" + session_userTypeDesc + ") |")))
            {
                response.sendRedirect(request.getContextPath() + "/pages/accessDenied.jsp");
            }
            else
            {
                response.sendRedirect(request.getContextPath() + "/pages/accessDenied.jsp?fp=Authorize_Activated_User");
            }
        }
        else
        {
...
<%
    ...
    col_user = DAOFactory.getUserDAO().getAuthPendingModifiedUser(session_userName, DDM_Constants.status_user_modify_activate, session_userType);
    ...
    else if (reqType.equals("1"))
    {
        ...
        authUser.setStatusModify(DDM_Constants.status_active);
        authUser.setStatus(userDetails.getStatus());
...
<html>
    <head>
        ...
        <script language="javascript" type="text/JavaScript">
            ...
            {
            setRequestType(true);        
            document.frmAuthActivatedUser.action="AuthActivatedUser.jsp";
            document.frmAuthActivatedUser.submit();
            return true;
                                                                ...
                                                                <td align="center" valign="middle"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="left" valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                    <tr>
                                                                                        <td width="10">&nbsp;</td>
                                                                                        <td align="left" valign="top" class="ddm_header_text">Authorize Activated User</td>
                                                                                        <td width="10">&nbsp;</td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td height="20"></td>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td align="center" valign="top">
                                                                                            <form method="post" name="frmAuthActivatedUser" id="frmAuthActivatedUser">
                                                                                                                                ...
                                                                                                                                <tr>
                                                                                                                                    <td align="center">
                                                                                                                                        ...
                                                                                                                                        <div id="displayMsg_success" class="ddm_Display_Success_msg" >
                                                                                                                                            ...
                                                                                                                                            User Activation Approved Sucessfully.
                                                                                                                                        ...
                                                                                                                                        <div id="displayMsg_error" class="ddm_Display_Error_msg" >User Activation Approval Failed.- <span class="ddm_error"><%=msg%></span></div>
                                                                                                                                            <%                                                                                            }
                                                                                                                                            %>
                                                                                                                                            ...
                                                                                                                                            <tr>
                                                                                                                                                <td>
                                                                                                                                                    ...
                                                                                                                                                    <table border="0" cellspacing="1" cellpadding="3"  bgcolor="#FFFFFF">
                                                                                                                                                        ...
                                                                                                                                                        <tr>
                                                                                                                                                            <td align="left" valign="middle" bgcolor="#A4B7CA" class="ddm_tbl_header_text">Modified By :</td>
                                                                                                                                                            <td colspan="2" valign="middle" class="ddm_tbl_common_text"><%=userDetails.getModifiedBy() != null ? userDetails.getModifiedBy() : "N/A"%></td>
                                                                                                                                                        </tr>
                                                                                                                                                        <tr>
                                                                                                                                                            <td align="left" valign="middle" bgcolor="#A4B7CA" class="ddm_tbl_header_text">Modified Date :</td>
