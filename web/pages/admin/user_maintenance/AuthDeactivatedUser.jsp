...
<%@page import="lk.com.ttsl.pb.slips.services.utils.CertificateRevoke" errorPage="../../../error.jsp"%>
...
<%
    ...
    else
    {
        ...
        {
            //session.invalidate();
            if (DAOFactory.getLogDAO().addLog(new Log(DDM_Constants.log_type_user_access_denied, "| Unauthorized access to page - 'LankaPay Direct Debit Mandate Exchange System - Authorize Deactivated User' | Accessed By - " + session_userName + " (" + session_userTypeDesc + ") |")))
            {
                response.sendRedirect(request.getContextPath() + "/pages/accessDenied.jsp");
            }
            else
            {
                response.sendRedirect(request.getContextPath() + "/pages/accessDenied.jsp?fp=Authorize_Deactivated_User");
            }
        }
        else
        {
...
//    String oldUserStatusDesc = null;
    ...
    col_user = DAOFactory.getUserDAO().getAuthPendingModifiedUser(session_userName, DDM_Constants.status_user_modify_deactivate, session_userType);
    ...
    else if (reqType.equals("1"))
    {
        ...
        authUser.setStatusModify(DDM_Constants.status_deactive);
...
//        oldUserStatusDesc = "Pending";
        ...
        {
            msg = userDAO.getMsg();
            DAOFactory.getLogDAO().addLog(new Log(DDM_Constants.log_type_admin_user_maintenance_authorize_deactivate_user, "| Username - " + userDetails.getUserId() + ", Type - " + userDetails.getUserLevelDesc() + ", Bank - " + userDetails.getBankCode() + ", Name - (New : " + newName + ", Old : " + (userDetails.getName() != null ? userDetails.getName() : "") + "), Designation - (New : " + newDesignation + ", Old : " + (userDetails.getDesignation() != null ? userDetails.getDesignation() : "") + "), E-Mail - (New : " + newEmail + ", Old : " + (userDetails.getEmail() != null ? userDetails.getEmail() : "") + "), Contact No. - (New : " + newContactNo + ", Old : " + (userDetails.getContactNo() != null ? userDetails.getContactNo() : "") + ") | Process Status - Unsuccess (" + msg + ") | Modified By - " + session_userName + " (" + session_userTypeDesc + ") |"));
        }
        else
        {
...
<html>
    <head>
        ...
        <script language="javascript" type="text/JavaScript">
            ...
            {
            setRequestType(true);        
            document.frmAuthDeactivatedUser.action="AuthDeactivatedUser.jsp";
            document.frmAuthDeactivatedUser.submit();
            return true;
                                                                ...
                                                                <td align="center" valign="middle"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="left" valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                    <tr>
                                                                                        <td width="10">&nbsp;</td>
                                                                                        <td align="left" valign="top" class="ddm_header_text">Authorize Deactivated User</td>
                                                                                        <td width="10">&nbsp;</td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td height="20"></td>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td align="center" valign="top">
                                                                                            <form method="post" name="frmAuthDeactivatedUser" id="frmAuthDeactivatedUser">
                                                                                                                                ...
                                                                                                                                <tr>
                                                                                                                                    <td align="center">
                                                                                                                                        ...
                                                                                                                                        <div id="displayMsg_success" class="ddm_Display_Success_msg" >
                                                                                                                                            ...
                                                                                                                                            User Deactivation Approved Sucessfully.
                                                                                                                                        ...
                                                                                                                                        <div id="displayMsg_error" class="ddm_Display_Error_msg" >User Deactivation Approval Failed.- <span class="ddm_error"><%=msg%></span></div>
                                                                                                                                            <%                                                                                            }
                                                                                                                                            %>
                                                                                                                                                ...
                                                                                                                                                <td>
                                                                                                                                                    ...
                                                                                                                                                    <table border="0" cellspacing="1" cellpadding="3"  bgcolor="#FFFFFF">
                                                                                                                                                        ...
                                                                                                                                                        <tr>
                                                                                                                                                            ...
                                                                                                                                                            <td colspan="2" valign="middle"class="ddm_tbl_common_text"><%=userDetails.getUserId()%><input type="hidden" name="hdnUsername" id="hdnUsername" class="ddm_success" value="<%=userDetails.getUserId()%>" /></td>
                                                                                                                                                        </tr>
                                                                                                                                                        <tr>
                                                                                                                                                        ...
                                                                                                                                                        <tr>
                                                                                                                                                            <td height="8" colspan="3" align="left" valign="middle" bgcolor="#CDCDCD" class="ddm_tbl_footer_text"></td>
                                                                                                                                                        </tr>
                                                                                                                                                        <tr>
                                                                                                                                                            <td align="left" valign="middle" class="ddm_tbl_header_text">Modified By :</td>
                                                                                                                                                            <td colspan="2" valign="middle" bgcolor="#E1E3EC" class="ddm_tbl_common_text"><%=userDetails.getModifiedBy() != null ? userDetails.getModifiedBy() : "N/A"%></td>
                                                                                                                                                        </tr>
                                                                                                                                                        <tr>
                                                                                                                                                            <td align="left" valign="middle" class="ddm_tbl_header_text">Modified Date :</td>
                                                                                                                                                            <td colspan="2" valign="middle" bgcolor="#E1E3EC" class="ddm_tbl_common_text"><%=userDetails.getModifiedDate() != null ? userDetails.getModifiedDate() : "N/A"%></td>
                                                                                                                                                        </tr>
                                                                                                                                                        <tr>
                                                                                                                                                            <td height="35" colspan="3" align="right" valign="middle" class="ddm_tbl_footer_text">                                                                                                                      <table border="0" cellpadding="0" cellspacing="0">
                                                                                                                                                                    <tr>
