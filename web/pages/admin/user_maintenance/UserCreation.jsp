...
<%
    ...
    else if (isReq.equals("0"))
    {
        ...
        if (newUserLevel != null && (newUserLevel.equals(DDM_Constants.user_type_bank_manager) || newUserLevel.equals(DDM_Constants.user_type_bank_user)))
        {
                                                                                                                                        ...
                                                                                                                                        <tr>
                                                                                                                                            <td height="35" colspan="2" align="right" valign="middle" class="ddm_tbl_footer_text">                                                                                                                     
                                                                                                                                                <table border="0" cellpadding="0" cellspacing="0">
                                                                                                                                                    <tr>
                                                                                                                                                        <td><input type="button" value="&nbsp;&nbsp; Create &nbsp;&nbsp;" name="btnAdd" class="ddm_custom_button" onClick="createUserSubmit()"/>                             </td>
