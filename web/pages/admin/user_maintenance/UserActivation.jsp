...
<%
    ...
    else
    {
        ...
        {
            //session.invalidate();
            if (DAOFactory.getLogDAO().addLog(new Log(DDM_Constants.log_type_user_access_denied, "| Unauthorized access to page - 'LankaPay Direct Debit Mandate Exchange System - Activate User' | Accessed By - " + session_userName + " (" + session_userTypeDesc + ") |")))
            {
                response.sendRedirect(request.getContextPath() + "/pages/accessDenied.jsp");
            }
            else
            {
                response.sendRedirect(request.getContextPath() + "/pages/accessDenied.jsp?fp=Activate_User");
            }
        }
        else
        {
...
<%
    ...
    else if (isReq.equals("1"))
    {
        ...
        //result = userDAO.setUserStatus(selectedUserId, DDM_Constants.status_active, true);
        result = userDAO.setUserStatusManual(selectedUserId, DDM_Constants.status_active, false, session_userName);
        ...
        {
            msg = userDAO.getMsg();
            DAOFactory.getLogDAO().addLog(new Log(DDM_Constants.log_type_admin_user_maintenance_activate_user, "| Username - " + selectedUserId + ", Status - (New : Active, Old : " + currentUserStat + ") | Process Status - Unsuccess (" + msg + ") | Modified By - " + session_userName + " (" + session_userTypeDesc + ") |"));
        }
        else
        {
            DAOFactory.getLogDAO().addLog(new Log(DDM_Constants.log_type_admin_user_maintenance_activate_user, "| Username - " + selectedUserId + ", Status - (New : Active, Old : " + currentUserStat + ") | Process Status - Success | Modified By - " + session_userName + " (" + session_userTypeDesc + ") |"));
        }
    }
%>
	...
	<head>
    	<title>LankaPay Direct Debit Mandate Exchange System - Activate User</title>
    ...
    <script language="javascript" type="text/JavaScript">
        ...
        if(selUser == "-1")
        {
        alert("You must select valid Username for Activation!");
                                                            ...
                                                            <td align="center" valign="middle"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td align="left" valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                <tr>
                                                                                    <td width="10">&nbsp;</td>
                                                                                    <td align="left" valign="top" class="ddm_header_text">Activate User</td>
                                                                                    <td width="10">&nbsp;</td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td height="20"></td>
                                                                                        ...
                                                                                        <form id="frmActivateUser" name="frmActivateUser" action="UserActivation.jsp">
                                                                                            ...
                                                                                            <table border="0" align="center" cellpadding="0" cellspacing="0">
                                                                                                ...
                                                                                                <%
                                                                                                    ...
                                                                                                    {%>
                                                                                                <tr>
                                                                                                    <td align="center" ><div id="displayMsg_success" class="ddm_Display_Success_msg" >User Activation Request Succesfully Posted!  <span class="ddm_error">(Manager Level Authorization Is Mandatory To Complete The Process!)</span><br/>
                                                                                                        </div></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td height="5" ></td>
                                                                                                ...
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td align="center" class="ddm_Display_Error_msg"><div id="displayMsg_error" class="ddm_Display_Error_msg" >User Activation Faile - <span class="ddm_error"><%=msg%></span></div></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td height="5" ></td>
                                                                                                </tr>
                                                                                                    ...
                                                                                                    <td align="center" valign="top" class="ddm_Display_Error_msg"><table border="0" cellspacing="0" cellpadding="0" class="ddm_table_boder" >
                                                                                                            ...
                                                                                                            <tr>
                                                                                                                <td><table border="0" cellspacing="1" cellpadding="3"  bgcolor="#FFFFFF" >
                                                                                                                        ...
                                                                                                                        <tr>
                                                                                                                            <td align="left" valign="middle" class="ddm_tbl_header_text">Username :</td>
