...
<%    
    ...
    if (isReq == null)
    {
        ...
        col_user = DAOFactory.getUserDAO().getUsers(new User(newUserLevel, newUserBank, newUserBranch, newUserStatus), "'" + DDM_Constants.status_deactive + "','" + DDM_Constants.status_pending + "'");
    }
                                                                                                            ...
                                                                                                            <tr>
                                                                                                                <td><table border="0" cellspacing="1" cellpadding="3"  bgcolor="#FFFFFF" >
                                                                                                                        ...
                                                                                                                        <tr>
                                                                                                                            ...
                                                                                                                            <td valign="middle" bgcolor="#E1E3EC"class="ddm_tbl_common_text"><select name="cmbBranch" id="cmbBranch" class="ddm_field_border" onChange="isRequest(false);frmDeActivateUser.submit()" onFocus="hideMessage_onFocus()">
                                                                                                                                    <%
                                                                                                                        ...
                                                                                                                        <tr>
                                                                                                                            <td height="35" colspan="2" align="right" valign="middle" bgcolor="#CDCDCD" class="ddm_tbl_footer_text"><input type="hidden" name="hdnReq" id="hdnReq" value="<%=isReq%>" />                                                                                                                              <table border="0" cellpadding="0" cellspacing="0">
                                                                                                                                    <tr>
