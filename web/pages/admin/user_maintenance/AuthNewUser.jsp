...
<%
    ...
    else
    {
        ...
        {
            //session.invalidate();
            if (DAOFactory.getLogDAO().addLog(new Log(DDM_Constants.log_type_user_access_denied, "| Unauthorized access to page - 'LankaPay Direct Debit Mandate Exchange System - Authorize New User' | Accessed By - " + session_userName + " (" + session_userTypeDesc + ") |")))
            {
                response.sendRedirect(request.getContextPath() + "/pages/accessDenied.jsp");
            }
            else
            {
                response.sendRedirect(request.getContextPath() + "/pages/accessDenied.jsp?fp=Authorize_New_User");
            }
        }
        else
        {
...
<%
    ...
    col_user = DAOFactory.getUserDAO().getAuthPendingUsers(session_userName, session_userType);
    ...
    else if (reqType.equals("1"))
    {
        ...
        result = userDAO.doAuthorizedNewUser(userID, session_userName);
        ...
        {
            msg = userDAO.getMsg();
            DAOFactory.getLogDAO().addLog(new Log(DDM_Constants.log_type_admin_user_maintenance_authorize_new_user, "| Username - " + userDetails.getUserId() + ", Type - " + userDetails.getUserLevelDesc() + ", Bank - " + userDetails.getBankCode() + ", Status - (New : " + newUserStatusDesc + ", Old : " + oldUserStatusDesc + "), Name - (New : " + newName + ", Old : " + (userDetails.getName() != null ? userDetails.getName() : "") + "), Designation - (New : " + newDesignation + ", Old : " + (userDetails.getDesignation() != null ? userDetails.getDesignation() : "") + "), E-Mail - (New : " + newEmail + ", Old : " + (userDetails.getEmail() != null ? userDetails.getEmail() : "") + "), Contact No. - (New : " + newContactNo + ", Old : " + (userDetails.getContactNo() != null ? userDetails.getContactNo() : "") + ") | Process Status - Unsuccess (" + msg + ") | Authorized By - " + session_userName + " (" + session_userTypeDesc + ") |"));
        }
        else
        {
            DAOFactory.getLogDAO().addLog(new Log(DDM_Constants.log_type_admin_user_maintenance_authorize_new_user, "| Username - " + userDetails.getUserId() + ", Type - " + userDetails.getUserLevelDesc() + ", Bank - " + userDetails.getBankCode() + ", Status - (New : " + newUserStatusDesc + ", Old : " + oldUserStatusDesc + "), Name - (New : " + newName + ", Old : " + (userDetails.getName() != null ? userDetails.getName() : "") + "), Designation - (New : " + newDesignation + ", Old : " + (userDetails.getDesignation() != null ? userDetails.getDesignation() : "") + "), E-Mail - (New : " + newEmail + ", Old : " + (userDetails.getEmail() != null ? userDetails.getEmail() : "") + "), Contact No. - (New : " + newContactNo + ", Old : " + (userDetails.getContactNo() != null ? userDetails.getContactNo() : "") + ") | Process Status - Success | Authorized By - " + session_userName + " (" + session_userTypeDesc + ") |"));
        }
    }
%>
                                                                ...
                                                                <td align="center" valign="middle"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="left" valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                    <tr>
                                                                                        <td width="10">&nbsp;</td>
                                                                                        <td align="left" valign="top" class="ddm_header_text">Authorize New User</td>
                                                                                        <td width="10">&nbsp;</td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td height="20"></td>
                                                                                                                    ...
                                                                                                                    <td><div id="resultdata"><table border="0" cellspacing="0" cellpadding="0">
                                                                                                                                <tr>
                                                                                                                                    <td align="center">
                                                                                                                                        ...
                                                                                                                                        <div id="displayMsg_error" class="ddm_Display_Error_msg" >User Approval Failed.- <span class="ddm_error"><%=msg%></span></div>
                                                                                                                                            <%                                                                                            }
                                                                                                                                            %>
                                                                                                                                                ...
                                                                                                                                                <td>
                                                                                                                                                    ...
                                                                                                                                                    <table border="0" cellspacing="1" cellpadding="3"  bgcolor="#FFFFFF">
                                                                                                                                                        ...
                                                                                                                                                        <%
                                                                                                                                                            ...
                                                                                                                                                            if (userDetails.getUserLevelId().equals(DDM_Constants.user_type_merchant_su) || userDetails.getUserLevelId().equals(DDM_Constants.user_type_merchant_op))
                                                                                                                                                            {
                                                                                                                                                        %>

                                                                                                                                                        <tr>
                                                                                                                                                            <td align="left" valign="middle" class="ddm_tbl_header_text">Corporate Customer ID :</td>
                                                                                                                                                            <td valign="middle" class="ddm_tbl_common_text"><%=userDetails.getCoCuId()%> - <%=userDetails.getCoCuName()%></td>
                                                                                                                                                        </tr>
                                                                                                                                                        ...
                                                                                                                                                        <tr>
                                                                                                                                                            <td align="left" valign="middle" nowrap class="ddm_tbl_header_text">Status :</td>
                                                                                                                                                            <td valign="middle" class="ddm_tbl_common_text"><%=((reqType != null && reqType.equals("1")) && result) ? newUserStatusDesc : oldUserStatusDesc%></td>
                                                                                                                                                        </tr>
                                                                                                                                                        <tr>
