...
%>
<html>
    <head><title>LankaPay Direct Debit Mandate Exchange System | View Execution Batch Status</title>
                                                                ...
                                                                <td align="center" valign="middle"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="left" valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                    <tr>
                                                                                        <td width="10">&nbsp;</td>
                                                                                        <td align="left" valign="top" class="ddm_header_text">View Execution Batch Status</td>
                                                                                        <td width="10">&nbsp;</td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td height="15"></td>
                                                                                        ...
                                                                                        <td align="center" valign="top">
                                                                                            <table border="0" cellspacing="1" cellpadding="4" class="ddm_table_boder" bgcolor="#FFFFFF">
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td align="center" class="ddm_tbl_header_text_horizontal">Batch<br>
                                                                                                        Name</td>
                                                                                                    <td align="center" class="ddm_tbl_header_text_horizontal">Batch<br>
                                                                                                        Status</td>
                                                                                                    <td align="center" class="ddm_tbl_header_text_horizontal">Start<br>
                                                                                                        Time</td>
                                                                                                    <td align="center" class="ddm_tbl_header_text_horizontal">End<br>
                                                                                                        Time</td>
                                                                                                ...
                                                                                                <tr bgcolor="<%=rowNum % 2 == 0 ? "#E8E8EA" : "#F9F9F9"%>"   onMouseOver="cOn(this)" onMouseOut="cOut(this)">
                                                                                                    ...
                                                                                                    <td align="left" class="ddm_common_text"><%=exec.getBatchName()%></td>
                                                                                                    <td align="center" class="ddm_common_text"><%=exec.getStatus()%></td>
                                                                                                    <td align="center" class="ddm_common_text"><%=exec.getStartTime() == null ? "Not available" : exec.getStartTime()%></td>
                                                                                                    <td align="center" class="ddm_common_text"><%=exec.getEndTime() == null ? "Not Available" : exec.getEndTime()%></td>
                                                                                                    <td align="center" class="ddm_common_text"><%=exec.getExecutedBy() == null ? "Not Available" : exec.getExecutedBy()%></td>
                                                                                                    <td align="center" class="ddm_common_text"><%=exec.getModule() == null ? "Not Available" : exec.getModule()%></td>
                                                                                                </tr>
                                                                                                <input type="hidden" name="hdnExeBatchId_<%=ctr%>" value="<%=exec.getBatchId()%>" />
                                                                                                <%
                                                                                                        ctr++;
                                                                                                    }
                                                                                                %>
