...
<%
    ...
    else
    {
        ...
        if (!isAccessOK)
        {
            ...
            {
                response.sendRedirect(request.getContextPath() + "/pages/accessDenied.jsp?fp=View_Calen            Details");
            }
        }
        else
        {
                                                                ...
                                                                <td align="center" valign="middle"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="left" valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                    <tr>
                                                                                        <td width="10">&nbsp;</td>
                                                                                        <td align="left" valign="top" class="ddm_header_text">Execution Batch Updation Comformation ..!</td>
                                                                                        <td width="10">&nbsp;</td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td height="15"></td>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td align="center" valign="top">
                                                                                            ...
                                                                                            <%
                                                                                                String col_size = request.getParameter("hdncol_size");
                                                                                                Collection<ExecutionBatch> col_ExecutionBatch = null;

                                                                                                if (col_size != null)
                                                                                                {
                                                                                                    col_ExecutionBatch = new ArrayList();

                                                                                                    for (int i = 1; i <= Integer.parseInt(col_size); i++)
                                                                                                    {

                                                                                                        String id = request.getParameter("hdnExeBatchId_" + i);
                                                                                                        // String status = request.getParameter("txtstatus_" + i);
                                                                                                        String status_cmbBox = request.getParameter("cmbStatus_" + i);

                                                                                                        String executedBy = request.getParameter("hdnExeBy_" + i);
                                                                                                        String module = request.getParameter("hdnModule_" + i);
                                                                                                        String currentStatus = request.getParameter("hdnCurrentStatus_" + i);

                                                                                                        System.out.println("currentStatus :" + currentStatus);

                                                                                                        if (!status_cmbBox.equals("SelectNewValue"))
                                                                                                        {
                                                                                                            //BatchStatus has not  been change to new value
                                                                                                            ExecutionBatch exec = new ExecutionBatch();

                                                                                                            exec.setBatchId(id);
                                                                                                            exec.setStatus(status_cmbBox);
                                                                                                            exec.setModifiedby(session_userName);
                                                                                                            exec.setExecutedBy(executedBy);
                                                                                                            exec.setModule(module);
                                                                                                            exec.setCurrentStatus(currentStatus);

                                                                                                            col_ExecutionBatch.add(exec);
                                                                                                ...
                                                                                                ExecutionBatchDAO dao_exec = DAOFactory.getExecutionBatchDAO();
                                                                                                boolean result = dao_exec.update(col_ExecutionBatch);

                                                                                                ExecutionBatchHistoryDAO dao_execHistory = DAOFactory.getExecutionBatchHistoryDAO();
                                                                                                boolean history_result = false;

                                                                                                if (result == true)
                                                                                                {
                                                                                                    history_result = dao_execHistory.update(col_ExecutionBatch);
                                                                                                }
                                                                                            ...
                                                                                            <table border="0" cellspacing="1" cellpadding="4" class="ddm_table_boder" bgcolor="#FFFFFF">
                                                                                                ...
                                                                                                <% if (col_ExecutionBatch.size() == 0)
                                                                                                    {

                                                                                                %>
                                                                                                <tr>
                                                                                                    <td colspan="3" align="center" class="ddm_header_small_text">No Changes to Update!</td>
                                                                                                    <!--  <td align="left" class="ddm_common_text"></td> -->
                                                                                                </tr>
                                                                                                <%}
                                                                                                else
                                                                                                {%>
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td align="center" class="ddm_tbl_header_text_horizontal">Batch Id</td>
                                                                                                ...
                                                                                                <%
                                                                                                    ...
                                                                                                    if (result == true)
                                                                                                    {
                                                                                                        HashMap<String, String> hm = dao_exec.getSuccessQuery();

                                                                                                        for (String key : hm.keySet())
                                                                                                        {

                                                                                                            String batchid = key;
                                                                                                            String value_status = hm.get(key);
                                                                                                ...
                                                                                                <tr bgcolor="<%=rowNum % 2 == 0 ? "#E8E8EA" : "#F9F9F9"%>"   onMouseOver="cOn(this)" onMouseOut="cOut(this)">
                                                                                                    ...
                                                                                                    <td align="left" class="ddm_common_text"><%=batchid%></td>
                                                                                                    <td align="left" class="ddm_common_text">Success</td>
                                                                                                </tr>
                                                                                                <%   }
                                                                                                                        // else if (value_status.equals("N")) {
                                                                                                        //out.println("No Any Status are Changed...!");
                                                                                                        // out.println(batchid+"-"+value_status);
                                                                                                        // }
                                                                                                    } //  out.print("end enumerator");
                                                                                                }
                                                                                                else
                                                                                                {
                                                                                                    HashMap<String, String> hm = dao_exec.getFailQuery();

                                                                                                    for (String key : hm.keySet())
                                                                                                    {
                                                                                                        String batchid = key;
                                                                                                        String value_status = hm.get(batchid);

                                                                                                        if (value_status.equals("F"))
                                                                                                        {
                                                                                                            rowNum++;
                                                                                                %>
                                                                                                <tr bgcolor="<%=rowNum % 2 == 0 ? "#E8E8EA" : "#F9F9F9"%>"   onMouseOver="cOn(this)" onMouseOut="cOut(this)">
                                                                                                    <td align="left" class="ddm_common_text"><%=rowNum%>.</td>
                                                                                                    <td align="left" class="ddm_common_text"><%=batchid%></td>
                                                                                                    <td align="left" class="ddm_common_text">Fail</td>
                                                                                                </tr>
                                                                                                <%}
                                                                                                            }
                                                                                                        }
