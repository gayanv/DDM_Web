...
<%
    ...
    colBank = DAOFactory.getBankDAO().getAuthPendingModifiedBank(session_userName);
    ...
    else if (reqType.equals("1"))
    {
        ...
        result = bankDAO.doAuthorizeModifiedBank(new Bank(bankDetails.getBankCode(), session_userName));

        if (!result)
        {
            msg = bankDAO.getMsg();
            DAOFactory.getLogDAO().addLog(new Log(DDM_Constants.log_type_admin_bank_branch_maintenance_authorized_modified_bank, "| Bank Code - " + bankDetails.getBankCode() + " | Process Status - Unsuccess (" + msg + ") | Authorized By - " + session_userName + " (" + session_userTypeDesc + ") |"));
        }
        else
        {
            DAOFactory.getLogDAO().addLog(new Log(DDM_Constants.log_type_admin_bank_branch_maintenance_authorized_modified_bank, "| Bank Code - " + bankDetails.getBankCode() + " | Process Status - Success | Authorized By - " + session_userName + " (" + session_userTypeDesc + ") |"));
        }
    }
%>
<html>
    <head>
        <title>LankaPay Direct Debit Mandate Exchange System - Authorize Modified Bank</title>
        ...
        <script language="javascript" type="text/JavaScript">
            ...
            document.frmApproveModifiedBank.action="AuthModifiedBank.jsp";
            document.frmApproveModifiedBank.submit();					
            }
                                                                ...
                                                                <td align="center" valign="middle"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="left" valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                    <tr>
                                                                                        <td width="10">&nbsp;</td>
                                                                                        <td align="left" valign="top" class="ddm_header_text">Authorize Modified Bank</td>
                                                                                        <td width="10">&nbsp;</td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td height="5"></td>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td align="center" valign="top" class="ddm_header_text">
                                                                                            <form name="frmApproveModifiedBank" id="frmApproveModifiedBank" method="post" >
                                                                                                                                ...
                                                                                                                                <tr>
                                                                                                                                    <td align="center">
                                                                                                                                        ...
                                                                                                                                        <div id="displayMsg_success" class="ddm_Display_Success_msg" >
                                                                                                                                            ...
                                                                                                                                            Modified Bank Details Approved Successfully!                                                                                                </div>
                                                                                                                                            <% }
                                                                                                                                            else
                                                                                                                                            {%>


                                                                                                                                        <div id="displayMsg_error" class="ddm_Display_Error_msg" >Modified Bank Details Approval Failed.- <span class="ddm_error"><%=msg%></span></div>
                                                                                                                                            <%                                                                                            }
                                                                                                                                            %>
                                                                                                                                    ...
                                                                                                                                    <td align="center" valign="middle">
                                                                                                                                        ...
                                                                                                                                        <table border="0" cellspacing="1" cellpadding="5" class="ddm_table_boder" bgcolor="#FFFFFF">
                                                                                                                                            ...
                                                                                                                                            <tr>
                                                                                                                                                ...
                                                                                                                                                <td colspan="2" class="ddm_tbl_common_text"><%=bankDetails.getBankCode()%></td>
                                                                                                                                            </tr>
                                                                                                                                            <tr>
                                                                                                                                                <td align="left" valign="middle" class="ddm_tbl_header_text">Short Name :</td>
                                                                                                                                                <td class="ddm_tbl_common_text"><%=bankDetails.getShortName() != null ? bankDetails.getShortName() : ""%></td>
                                                                                                                                                <td class="ddm_tbl_common_text"><%=bankDetails.getShortNameModify() != null ? bankDetails.getShortNameModify() : ""%></td>
                                                                                                                                            </tr>
                                                                                                                                            <tr>
                                                                                                                                                <td align="left" valign="middle" class="ddm_tbl_header_text">Full Name :</td>
                                                                                                                                                <td class="ddm_tbl_common_text"><%=bankDetails.getBankFullName() != null ? bankDetails.getBankFullName() : ""%></td>
                                                                                                                                                <td class="ddm_tbl_common_text"><%=bankDetails.getBankFullNameModify() != null ? bankDetails.getBankFullNameModify() : ""%></td>
                                                                                                                                            </tr>
                                                                                                                                            <tr>
                                                                                                                                                <td align="left" valign="middle" class="ddm_tbl_header_text">Bank Status :</td>
                                                                                                                                                ...
                                                                                                                                                <%
                                                                                                                                                    ...
                                                                                                                                                    if (bankDetails.getStatusModify() == null)
                                                                                                                                                    {
                                                                                                                                                        statModify = "N/A";
                                                                                                                                                    }
                                                                                                                                                    else if (bankDetails.getStatusModify().equals(DDM_Constants.status_active))
                                                                                                                                                    {
                                                                                                                                                        statModify = "Active";
                                                                                                                                                    }
                                                                                                                                                    else if (bankDetails.getStatusModify().equals(DDM_Constants.status_deactive))
                                                                                                                                                    {
                                                                                                                                                        statModify = "Inactive";
                                                                                                                                                    }
                                                                                                                                                    else if (bankDetails.getStatusModify().equals(DDM_Constants.status_pending))
                                                                                                                                                    {
                                                                                                                                            ...
                                                                                                                                            <tr>
                                                                                                                                              ...
                                                                                                                                              <td colspan="2" class="ddm_tbl_common_text"><%=bankDetails.getModifiedBy() %></td>
                                                                                                                                            </tr>
                                                                                                                                            <tr>
                                                                                                                                              <td align="left" valign="middle" class="ddm_tbl_header_text">Modified Date :</td>
                                                                                                                                              <td colspan="2" class="ddm_tbl_common_text"><%=bankDetails.getModifiedDate() %></td>
                                                                                                                                            </tr>
