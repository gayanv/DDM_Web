...
<%
    ...
    else
    {
        ...
        if (!isAccessOK)
        {
            if (DAOFactory.getLogDAO().addLog(new Log(DDM_Constants.log_type_user_access_denied, "| Unauthorized access to page - 'LankaPay Direct Debit Mandate Exchange System - View Branch Details' | Accessed By - " + session_userName + " (" + session_userTypeDesc + ") |")))
            {
                response.sendRedirect(request.getContextPath() + "/pages/accessDenied.jsp");
            }
            else
            {
                response.sendRedirect(request.getContextPath() + "/pages/accessDenied.jsp?fp=View_Branch_Details");
            }
        }
        else
        {
...
<%
    ...
    else if (isSearchReq.equals("1"))
    {
        ...
        DAOFactory.getLogDAO().addLog(new Log(DDM_Constants.log_type_admin_bank_branch_maintenance_view_branch_details, "| Search Criteria - (Bank Code : " + bankCode + " Status : " + statusDesc + ") | Result Count - " + colResult.size() + " | Viewed By - " + session_userName + " (" + session_userTypeDesc + ") |"));
    }
...
<html>
    <head>
        <title>LankaPay Direct Debit Mandate Exchange System - View Branch Details</title>
                                                                                                                            ...
                                                                                                                            <tr>
                                                                                                                                ...
                                                                                                                                <td align="left" valign="middle" class="ddm_tbl_common_text">
                                                                                                                                    <select name="cmbStatus" id="cmbStatus" class="ddm_field_border" onChange="clearResultData()">
                                                                                                                                        ...
                                                                                                                                        <option value="<%=DDM_Constants.status_pending%>" <%=status != null && status.equals(DDM_Constants.status_pending) ? "selected" : ""%>>Pending</option>
                                                                                                                                    </select></td>
                                                                                                                            </tr>
                                                                                                                            <tr>
                                                                                        ...
                                                                                        {%>
                                                                                                            ...
                                                                                                            <tr>
                                                                                                                <td><div id="resultdata">
                                                                                                                      ...
                                                                                                                      <tr>
                                                                                                                                <td align="right" bgcolor="#A4B7CA" class="ddm_tbl_header_text_horizontal_small"></td>
                                                                                                                                <td align="center" bgcolor="#A4B7CA" class="ddm_tbl_header_text_horizontal_small">Bank</td>
                                                                                                                                <td align="center" bgcolor="#A4B7CA" class="ddm_tbl_header_text_horizontal_small">Branch Code</td>
                                                                                                                                <td align="center" bgcolor="#A4B7CA" class="ddm_tbl_header_text_horizontal_small">Branch Name<br>
                                                                                                                              (Current)</td>
                                                                                                                                <td align="center" bgcolor="#A4B7CA" class="ddm_tbl_header_text_horizontal_small">Branch Name<br>                                                                                                                                  
                                                                                                                              (Modified)</td>
                                                                                                                                <td align="center" bgcolor="#A4B7CA" class="ddm_tbl_header_text_horizontal_small">Status<br>
                                                                                                                              (Current)</td>
                                                                                                                                <td align="center" bgcolor="#A4B7CA" class="ddm_tbl_header_text_horizontal_small">Status<br>                                                                                                                                  
                                                                                                                              (Modified)</td>
                                                                                                                                <td align="center" bgcolor="#A4B7CA" class="ddm_tbl_header_text_horizontal_small">Created<br>
                                                                                                                              By</td>
                                                                                                                                <td align="center" bgcolor="#A4B7CA" class="ddm_tbl_header_text_horizontal_small">Created<br>
                                                                                                                              Time</td>
                                                                                                                                <td align="center" bgcolor="#A4B7CA" class="ddm_tbl_header_text_horizontal_small">Authorized<br>
                                                                                                                              By</td>
                                                                                                                                <td align="center" bgcolor="#A4B7CA" class="ddm_tbl_header_text_horizontal_small">Authorized<br>
                                                                                                                              Time</td>
                                                                                                                                <td align="center" bgcolor="#A4B7CA" class="ddm_tbl_header_text_horizontal_small">Modified<br>
                                                                                                                              By</td>
                                                                                                                                <td align="center" bgcolor="#A4B7CA" class="ddm_tbl_header_text_horizontal_small">Modified<br>
                                                                                                                              Time</td>
                                                                                                                                <td align="center" bgcolor="#A4B7CA" class="ddm_tbl_header_text_horizontal_small">Modification<br>
                                                                                                                                  Authorized<br>
                                                                                                                              By</td>
                                                                                                                                <td align="center" bgcolor="#A4B7CA" class="ddm_tbl_header_text_horizontal_small">Modification<br>
                                                                                                                                  Authorized<br>
                                                                                                                            ...
                                                                                                                            <tr bgcolor="<%=rowNum % 2 == 0 ? "#E8E8EA" : "#F9F9F9"%>"   onMouseOver="cOn(this)" onMouseOut="cOut(this)">
                                                                                                                                ...
                                                                                                                                <td align="center"  class="ddm_common_text"><span class="ddm_common_text" title="<%=branch.getBankFullName()%>"><%=branch.getBankCode() + " - " + branch.getBankShortName()%></span></td>
                                                                                                                                <td align="center"  class="ddm_common_text"><%=branch.getBranchCode()%></td>
                                                                                                                                <td  class="ddm_common_text"><%=branch.getBranchName()%></td>
                                                                                                                                <td  class="ddm_common_text"><%=(branch.getBranchNameModify()!=null?branch.getBranchNameModify():"N/A")%></td>
                                                                                                                                <td align="center"  class="ddm_common_text"><%=branch.getStatus() != null ? branch.getStatus().equals(DDM_Constants.status_active) ? "Active" : branch.getStatus().equals(DDM_Constants.status_pending) ? "Pending" : "Inactive" : "N/A"%></td>
                                                                                                                                <td align="center"  class="ddm_common_text"><%=branch.getStatusModify()!= null ? branch.getStatusModify().equals(DDM_Constants.status_active) ? "Active" : branch.getStatusModify().equals(DDM_Constants.status_pending) ? "Pending" : "Inactive" : "N/A"%></td>
                                                                                                                                <td  class="ddm_common_text"><%=branch.getCreatedBy() != null ? branch.getCreatedBy() : "N/A"%></td>
                                                                                                                                <td align="center"  class="ddm_common_text"><%=branch.getCreatedDate() != null ? branch.getCreatedDate() : "N/A"%></td>
                                                                                                                                <td  class="ddm_common_text"><%=branch.getAuthorizedBy() != null ? branch.getAuthorizedBy() : "N/A"%></td>
                                                                                                                                <td align="center"  class="ddm_common_text"><%=branch.getAuthorizedDate() != null ? branch.getAuthorizedDate() : "N/A"%></td>
                                                                                                                                <td  class="ddm_common_text"><%=branch.getModifiedBy() != null ? branch.getModifiedBy() : "N/A"%></td>
                                                                                                                                <td align="center"  class="ddm_common_text"><%=branch.getModifiedDate() != null ? branch.getModifiedDate() : "N/A"%></td>
                                                                                                                                <td  class="ddm_common_text"><%=branch.getModificationAuthBy() != null ? branch.getModificationAuthBy() : "N/A"%></td>
                                                                                                                                <td align="center"  class="ddm_common_text"><%=branch.getModificationAuthDate() != null ? branch.getModificationAuthDate() : "N/A"%></td>
                                                                                                                            </tr>
