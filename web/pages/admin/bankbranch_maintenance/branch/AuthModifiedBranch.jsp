...
<%
    ...
    else
    {
        ...
        {
            //session.invalidate();
            if (DAOFactory.getLogDAO().addLog(new Log(DDM_Constants.log_type_user_access_denied, "| Unauthorized access to page - 'LankaPay Direct Debit Mandate Exchange System - Authorize Modified Branch' | Accessed By - " + session_userName + " (" + session_userTypeDesc + ") |")))
            {
                response.sendRedirect(request.getContextPath() + "/pages/accessDenied.jsp");
            }
            else
            {
                response.sendRedirect(request.getContextPath() + "/pages/accessDenied.jsp?fp=Authorize_Modified_Branch");
            }
        }
        else
        {
...
<%
    ...
    colBank = DAOFactory.getBranchDAO().getBanksListOfAuthPendingModifiedBranches(session_userName);
    ...
    else if (reqType.equals("0"))
    {
        ...
        {
            colBranch = DAOFactory.getBranchDAO().getAuthPendingModifiedBranches(cmbBankCode, session_userName);
    ...
    else if (reqType.equals("1"))
    {
        ...
        result = branchDAO.doAuthorizedModifiedBranch(new Branch(bankCode, branchCode, session_userName));

        if (!result)
        {
            msg = branchDAO.getMsg();
            DAOFactory.getLogDAO().addLog(new Log(DDM_Constants.log_type_admin_bank_branch_maintenance_authorized_modified_branch, "| Bank Code - " + bankCode + ", Branch Code - " + branchCode + ", Branch Name - " + branchName + ", Branch Status - " + branchDetails.getStatus() + " | Process Status - Unsuccess (" + msg + ") | Modified By - " + session_userName + " (" + session_userTypeDesc + ") |"));
        }
        else
        {
            //branchDetails.setStatus(DDM_Constants.status_active);
            DAOFactory.getLogDAO().addLog(new Log(DDM_Constants.log_type_admin_bank_branch_maintenance_authorized_modified_branch, "| Bank Code - " + bankCode + ", Branch Code - " + branchCode + ", Branch Name - " + branchName + ", Branch Status - " + branchDetails.getStatus() + " | Process Status - Success | Modified By - " + session_userName + " (" + session_userTypeDesc + ") |"));
        }
    }
%>
<html>
    <head>
        <title>LankaPay Direct Debit Mandate Exchange System - Authorize Modified Branch</title>
...
//            }
            ...
            document.frmAuthModifiedBranch.action="AuthModifiedBranch.jsp";
            document.frmAuthModifiedBranch.submit();
            return true;			
            }
                                                                ...
                                                                <td align="center" valign="middle"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="left" valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                    <tr>
                                                                                        <td width="10">&nbsp;</td>
                                                                                        <td align="left" valign="top" class="ddm_header_text">Authorize Modified Branch</td>
                                                                                        <td width="10">&nbsp;</td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td height="5"></td>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td height="5"></td>
                                                                                        <td align="center" valign="top" class="ddm_header_text"><form name="frmAuthModifiedBranch" id="frmAuthModifiedBranch" method="post" >
                                                                                                        ...
                                                                                                        <td align="center" valign="middle"><table border="0" align="center" cellspacing="1" cellpadding="3" class="ddm_table_boder" bgcolor="#FFFFFF">
                                                                                                                <tr>
                                                                                                                    ...
                                                                                                                    <td align="left" valign="middle" class="ddm_tbl_common_text">
                                                                                                                        <select name="cmbBank" id="cmbBank" class="ddm_field_border" onChange="doSearchBank();">
                                                                                                                                ...
                                                                                                                                <tr>
                                                                                                                                    <td align="center">
                                                                                                                                        ...
                                                                                                                                        <div id="displayMsg_success" class="ddm_Display_Success_msg" >
                                                                                                                                            ...
                                                                                                                                            Branch Modifications Approved Sucessfully.                                                                                                </div>
                                                                                                                                            <% }
                                                                                                                                            else
                                                                                                                                            {%>


                                                                                                                                        <div id="displayMsg_error" class="ddm_Display_Error_msg" >Branch Modification Approval Failed.- <span class="ddm_error"><%=msg%></span></div>
                                                                                                                                            <%                                                                                            }
                                                                                                                                            %>
                                                                                                                                    ...
                                                                                                                                    <td align="center" valign="middle">
                                                                                                                                        ...
                                                                                                                                        <table border="0" cellspacing="1" cellpadding="5" class="ddm_table_boder" bgcolor="#FFFFFF">
                                                                                                                                            ...
                                                                                                                                            <tr>
                                                                                                                                                ...
                                                                                                                                                <td align="left" valign="middle" class="ddm_tbl_common_text"><%=branchDetails.getBankCode() != null ? branchDetails.getBankCode() : ""%> <input type="hidden" name="txtBankCode" id="txtBankCode" class="ddm_success" value="<%=branchDetails.getBankCode()%>" />                                                                                </td>
                                                                                                                                            ...
                                                                                                                                            <tr>
                                                                                                                                                ...
                                                                                                                                                <td align="left" valign="middle" class="ddm_tbl_common_text"><%=branchDetails.getBranchCode() != null ? branchDetails.getBranchCode() : ""%><input type="hidden" name="txtBranchCode" id="txtBranchCode" class="ddm_success" value="<%=branchDetails.getBranchCode()%>" /></td>
                                                                                                                                                <td align="left" valign="middle" class="ddm_tbl_common_text"></td>
                                                                                                                                            </tr>
                                                                                                                                            <tr>
                                                                                                                                                <td align="left" valign="middle" class="ddm_tbl_header_text">Branch Name :</td>
                                                                                                                                                <td align="left" valign="middle" class="ddm_tbl_common_text"><%=branchDetails.getBranchName() != null ? branchDetails.getBranchName() : ""%><input name="txtBranchName" type="hidden" class="ddm_field_border" id="txtBranchName" size="50" value="<%=branchName != null ? branchName : ""%>"/>                                                                              </td>
                                                                                                                                                <td align="left" valign="middle" class="ddm_tbl_common_text"><%=branchDetails.getBranchNameModify() != null ? branchDetails.getBranchNameModify() : ""%></td>
                                                                                                                                            </tr>
                                                                                                                                            <tr>
                                                                                                                                                ...
                                                                                                                                                <%
                                                                                                                                                    ...
                                                                                                                                                    if (branchDetails.getStatusModify() == null)
                                                                                                                                                    {
                                                                                                                                                        statModify = "N/A";
                                                                                                                                                    }
                                                                                                                                                    else if (branchDetails.getStatusModify().equals(DDM_Constants.status_active))
                                                                                                                                                    {
                                                                                                                                                        statModify = "Active";
                                                                                                                                                    }
                                                                                                                                                    else if (branchDetails.getStatusModify().equals(DDM_Constants.status_deactive))
                                                                                                                                                    {
                                                                                                                                                        statModify = "De-Active";
                                                                                                                                                    }
                                                                                                                                                    else if (branchDetails.getStatusModify().equals(DDM_Constants.status_pending))
                                                                                                                                                    {
                                                                                                                                                ...
                                                                                                                                                <td align="left" valign="middle" class="ddm_tbl_common_text">
                                                                                                                                                    ...
                                                                                                                                                    <%=stat%>                                                                                                                        </td>
                                                                                                                                                <td align="left" valign="middle" class="ddm_tbl_common_text"><%=statModify%></td>
                                                                                                                                            </tr>
                                                                                                                                            <tr>
                                                                                                                                            ...
                                                                                                                                            <tr>
                                                                                                                                                ...
                                                                                                                                                <td colspan="2" align="left" valign="middle" class="ddm_tbl_common_text"><%=branchDetails.getModifiedBy()%></td>
                                                                                                                                            </tr>
                                                                                                                                            <tr>
                                                                                                                                                <td align="left" valign="middle" class="ddm_tbl_header_text">Modified Date :</td>
                                                                                                                                                <td colspan="2" align="left" valign="middle" class="ddm_tbl_common_text"><%=branchDetails.getModifiedDate()%></td>
                                                                                                                                            </tr>
                                                                                                                                            <tr>  <td height="35" colspan="3" align="right" class="ddm_tbl_footer_text">
                                                                                                                                                    ...
                                                                                                                                                    <table border="0" cellpadding="0" cellspacing="0">
                                                                                                                                                        <tr>
                                                                                                                                                            ...
                                                                                                                                                            <td width="5"></td>
                                                                                                                                                            <td><input type="button" name="btnClear" id="btnClear" value="&nbsp;&nbsp; <%=((reqType != null && reqType.equals("1")) && result) ? "OK" : "Cancel"%> &nbsp;&nbsp;" class="ddm_custom_button" onClick="cancel()"/>                                                            </td></tr>
                                                                                                                                                    </table>
