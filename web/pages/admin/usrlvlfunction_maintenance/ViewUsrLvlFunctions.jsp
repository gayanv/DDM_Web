...
<%
    ...
    else
    {
        ...
        if (!isAccessOK)
        {
            if (DAOFactory.getLogDAO().addLog(new Log(DDM_Constants.log_type_user_access_denied, "| Unauthorized access to page - 'LankaPay Direct Debit Mandate Exchange System - View User-Level Function Mapping Details' | Accessed By - " + session_userName + " (" + session_userTypeDesc + ") |")))
            {
                response.sendRedirect(request.getContextPath() + "/pages/accessDenied.jsp");
            }
            else
            {
                response.sendRedirect(request.getContextPath() + "/pages/accessDenied.jsp?fp=View_User_Level_Function_Mapping_Details");
            }
        }
        else
        {
...
<%
    ...
    Collection<UserLevelFunctionMap> colResult = null;
    ...
    if (isSearchReq == null)
    {
        ...
        funcStat = DDM_Constants.status_all;

    }
    else if (isSearchReq.equals("1"))
    {
        usrLvl = (String) request.getParameter("cmbUserLevel");
        funcStat = (String) request.getParameter("cmbFunctionStatus");

        colResult = DAOFactory.getUserLevelFunctionMapDAO().getUserLevelFunctionMapDetails(usrLvl, funcStat);

        String statusDesc = funcStat.equals(DDM_Constants.status_active) ? "Active" : funcStat.equals(DDM_Constants.status_deactive) ? "Inactive" : funcStat.equals(DDM_Constants.status_all) ? "All" : "N/A";
        DAOFactory.getLogDAO().addLog(new Log(DDM_Constants.log_type_admin_usr_lvl_func_map_maintenance_view_userlevel_function_mapping_details, "| Search Criteria - (User Level : " + usrLvl + " Function Status : " + statusDesc + ") | Result Count - " + colResult.size() + " | Viewed By - " + session_userName + " (" + session_userTypeDesc + ") |"));
    }
...
<html>
    <head>
    	<title>LankaPay Direct Debit Mandate Exchange System - View User-Level Function Mapping Details</title>
                                                                ...
                                                                <td align="center" valign="middle"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="left" valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                    <tr>
                                                                                        <td width="10">&nbsp;</td>
                                                                                        <td align="left" valign="top" class="ddm_header_text"> View User-Level &amp; Function Mapping Details</td>
                                                                                        <td width="10">&nbsp;</td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td height="15"></td>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td align="center" valign="top" class="ddm_header_text">
                                                                                            <form name="frmViewUsrLvlFunctionMap" id="frmViewUsrLvlFunctionMap" method="post" action="ViewUsrLvlFunctions.jsp">
                                                                                                                    ...
                                                                                                                    <td><table border="0" align="center" cellspacing="1" cellpadding="3"  bgcolor="#FFFFFF">
                                                                                                                            <tr>
                                                                                                                                ...
                                                                                                                                <td align="left" valign="middle" class="ddm_tbl_common_text">
                                                                                                                                    <select name="cmbUserLevel" id="cmbUserLevel" class="ddm_field_border" onChange="clearResultData();" <%=(session_userType.equals(DDM_Constants.user_type_bank_manager) || session_userType.equals(DDM_Constants.user_type_bank_user) || session_userType.equals(DDM_Constants.user_type_merchant_su)) ? "disabled" : ""%>>
                                                                                                                                        <%
                                                                                                                                        ...
                                                                                                                                        <%}
                                                                                                                                            if (colUsrLevel != null && colUsrLevel.size() > 0)
                                                                                                                                            {

                                                                                                                                                for (UserLevel ul : colUsrLevel)
                                                                                                                                                {
                                                                                                                                        %>
                                                                                                                                        <option value="<%=ul.getUserLevelId()%>" <%=(usrLvl != null && ul.getUserLevelId().equals(usrLvl)) ? "selected" : ""%>><%=ul.getUserLevelDesc()%></option>
                                                                                                                            ...
                                                                                                                            <tr>
                                                                                                                                ...
                                                                                                                                <td align="left" valign="middle" class="ddm_tbl_common_text">
                                                                                                                                    <select name="cmbFunctionStatus" id="cmbFunctionStatus" class="ddm_field_border" onChange="doSearchBranch();">
                                                                                                                                        <option value="<%=DDM_Constants.status_all%>" <%=(funcStat != null && funcStat.equals(DDM_Constants.status_all)) ? "selected" : ""%>>-- All --</option>
                                                                                                                                        <option value="<%=DDM_Constants.status_active%>" <%=(funcStat != null && funcStat.equals(DDM_Constants.status_active)) ? "selected" : ""%>>Active</option>
                                                                                                                                        <option value="<%=DDM_Constants.status_deactive%>" <%=(funcStat != null && funcStat.equals(DDM_Constants.status_deactive)) ? "selected" : ""%>>Inactive</option>
                                                                                                                                    </select>
                                                                                                                                </td>
                                                                                                                            </tr>
                                                                                                                            <tr>
                                                                                                                                <td colspan="2" align="right" class="ddm_tbl_footer_text"><table cellpadding="0" cellspacing="0" border="0">
                                                                                                                                        <tr>
                                                                                                                                            ...
                                                                                                                                            <td align="right"><input name="btnSearch" id="btnSearch" value="&nbsp;&nbsp; Search &nbsp;&nbsp;" type="button" onClick="isSearchRequest(true);
                                                                                                                                                    frmViewUsrLvlFunctionMap.submit()"  class="ddm_custom_button"/></td>
                                                                                                                                        </tr>
                                                                                                                                    </table></td>
                                                                                                                            </tr>
                                                                                                                        </table></td>
                                                                                                                ...
                                                                                                                <td><div id="resultdata">
                                                                                                                        <table  border="0" cellspacing="1" cellpadding="4" class="ddm_table_boder" bgcolor="#FFFFFF">
                                                                                                                            <tr>
                                                                                                                                ...
                                                                                                                                <td align="center" class="ddm_tbl_header_text_horizontal">User<br>
                                                                                                                                    Level</td>
                                                                                                                                <td align="center" class="ddm_tbl_header_text_horizontal">Function<br>
                                                                                                                                    Type</td>
                                                                                                                                <td align="center" class="ddm_tbl_header_text_horizontal">Status<br>
                                                                                                                                    (Current)</td>
                                                                                                                                <td align="center" class="ddm_tbl_header_text_horizontal">Status<br>
                                                                                                                                    (Modified)</td>
                                                                                                                                ...
                                                                                                                                <td align="center" class="ddm_tbl_header_text_horizontal">Modified<br>
                                                                                                                                    Time</td>
                                                                                                                                <td align="center" class="ddm_tbl_header_text_horizontal">Modification<br>
                                                                                                                                    Authorized<br>By</td>
                                                                                                                                <td align="center" class="ddm_tbl_header_text_horizontal">Modification<br>
                                                                                                                                    Authorized<br>Time</td>
                                                                                                                            </tr>
                                                                                                                            <%
                                                                                                                                int rowNum = 0;

                                                                                                                                for (UserLevelFunctionMap ulfm : colResult)
                                                                                                                                {
                                                                                                                                    rowNum++;
                                                                                                                            ...
                                                                                                                            <tr bgcolor="<%=rowNum % 2 == 0 ? "#E8E8EA" : "#F9F9F9"%>"   onMouseOver="cOn(this)" onMouseOut="cOut(this)">
                                                                                                                                ...
                                                                                                                                <td  class="ddm_common_text"><span class="ddm_common_text"><%=ulfm.getUserLevelDesc()%></span></td>
                                                                                                                                <td  class="ddm_common_text"><%=strFuncType%></td>
                                                                                                                                <td  class="ddm_common_text"><%=ulfm.getStatus() != null ? ulfm.getStatus().equals(DDM_Constants.status_active) ? "Active" : "Inactive" : "N/A"%></td>
                                                                                                                                <td  class="ddm_common_text"><%=ulfm.getStatusModify() != null ? ulfm.getStatusModify().equals(DDM_Constants.status_active) ? "Active" : ulfm.getStatusModify().equals(DDM_Constants.status_pending) ? "Pending" : "Inactive" : "N/A"%></td>
                                                                                                                                <td  class="ddm_common_text"><%=ulfm.getModifiedBy() != null ? ulfm.getModifiedBy() : "N/A"%></td>
                                                                                                                                <td align="center"  class="ddm_common_text"><%=ulfm.getModifiedDate() != null ? ulfm.getModifiedDate() : "N/A"%></td>
                                                                                                                                <td  class="ddm_common_text"><%=ulfm.getModificationAuthBy() != null ? ulfm.getModificationAuthBy() : "N/A"%></td>
                                                                                                                                <td align="center"  class="ddm_common_text"><%=ulfm.getModificationAuthDate() != null ? ulfm.getModificationAuthDate() : "N/A"%></td>
                                                                                                                            </tr>
                                                                                                                            ...
                                                                                                                            <tr  class="ddm_common_text">
                                                                                                                                <td height="20" align="right" class="ddm_tbl_footer_text" ></td>
