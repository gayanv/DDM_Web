...
<%@page import="lk.com.ttsl.pb.slips.services.jsmenu.*" errorPage="../../../../error.jsp"%>
...
//        System.out.println("request.getServletPath() ---> " + request.getServletPath());
        ...
        {
            //session.invalidate();
            if (DAOFactory.getLogDAO().addLog(new Log(DDM_Constants.log_type_user_access_denied, "| Unauthorized access to page - 'LankaPay Direct Debit Mandate Exchange System - Authorize Modified User-Level & Function Mappings' | Accessed By - " + session_userName + " (" + session_userTypeDesc + ") |")))
            {
                response.sendRedirect(request.getContextPath() + "/pages/accessDenied.jsp");
            }
            else
            {
                response.sendRedirect(request.getContextPath() + "/pages/accessDenied.jsp?fp=Authorize_Modified_User_Level_Function_Mappings");
            }
        }
        else
        {
...
<%
    ...
    else if (reqType.equals("0"))
    {
        ...
        if (cmbUserLevel != null && !cmbUserLevel.equals("-1"))
        {
            colULFM = DAOFactory.getUserLevelFunctionMapDAO().getAuthPendingModifiedFunctionMap(cmbUserLevel, session_userName);

            cmbFunctionID = (String) request.getParameter("cmbFunctionID");

            if (cmbFunctionID != null && !cmbFunctionID.equals("-1"))
            {
                int iFunctionID = 0;
    ...
    else if (reqType.equals("1"))
    {
        ...
        functionID = ulfm.getFunctionID();
        status = ulfm.getStatus();
        status_New = ulfm.getStatusModify();

        UserLevelFunctionMapDAO ulfmDAO = DAOFactory.getUserLevelFunctionMapDAO();

        result = ulfmDAO.doAuthorizeModifiedParams(new UserLevelFunctionMap(userLevelID, functionID, session_userName));
        ...
        {
            msg = ulfmDAO.getMsg();
            DAOFactory.getLogDAO().addLog(new Log(DDM_Constants.log_type_admin_usr_lvl_func_map_maintenance_authorized_modified_userlevel_function_mapping, "| User Level - " + userLevelID + ", Function Type - " + strfunctionDesc + ", Status - (New : " + (status_New != null ? status_New.equals(DDM_Constants.status_active) ? "Active" : "Inactive" : "N/A") + ", Old : " + (status != null ? status.equals(DDM_Constants.status_active) ? "Active" : "Inactive" : "N/A") + ") | Process Status - Unsuccess (" + msg + ") | Modified By - " + session_userName + " (" + session_userTypeDesc + ") |"));
        }
        else
        {
            jsPath = request.getServletContext().getRealPath(DDM_Constants.directory_separator_web) + DDM_Constants.directory_separator + "js" + DDM_Constants.directory_separator;
            //System.out.println("jsPath ---> " + jsPath);
            JS_MenuCreator.CreateMenu(userLevelID, jsPath);
...
<html>
    <head>
    	<title>LankaPay Direct Debit Mandate Exchange System - Authorize Modified User-Level & Function Mappings</title>
        ...
        <script language="javascript" type="text/JavaScript">
            ...
            document.frmAuthModifiedBranch.action="AuthModifiedUsrLvlFunctions.jsp";
                                                                ...
                                                                <td align="center" valign="middle"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="left" valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                    <tr>
                                                                                        <td width="10">&nbsp;</td>
                                                                                        <td align="left" valign="top" class="ddm_header_text">Authorize Modified User-Level &amp; Function Mappings</td>
                                                                                        <td width="10">&nbsp;</td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td height="5"></td>
                                                                                                        ...
                                                                                                        <td align="center" valign="middle"><table border="0" align="center" cellspacing="1" cellpadding="3" class="ddm_table_boder" bgcolor="#FFFFFF">
                                                                                                                <tr>
                                                                                                                    ...
                                                                                                                    <td align="left" valign="middle" class="ddm_tbl_common_text">
                                                                                                                        <select name="cmbUserLevel" id="cmbUserLevel" class="ddm_field_border" onChange="doSearchUserLevel();">
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    ...
                                                                                                                    <td align="left" valign="middle" class="ddm_tbl_common_text">
                                                                                                                        <select name="cmbFunctionID" id="cmbFunctionID" class="ddm_field_border" onChange="doSearchFunctionID()">
                                                                                                                            ...
                                                                                                                            %>
                                                                                                                            <option value="<%=strFuncID%>" <%=(cmbFunctionID != null && strFuncID.equals(cmbFunctionID)) ? "selected" : ""%>><%=strFuncType%></option>
                                                                                                                            <%
                                                                                                                                }
                                                                                                                            %> 
                                                                                                                        </select>
                                                                                                                                ...
                                                                                                                                <tr>
                                                                                                                                    <td align="center">
                                                                                                                                        ...
                                                                                                                                        <div id="displayMsg_success" class="ddm_Display_Success_msg" >
                                                                                                                                            ...
                                                                                                                                            'User Level &amp; Function Mapping' Modifications Approved Successfully.                                                                                                </div>
                                                                                                                                            <% }
                                                                                                                                            else
                                                                                                                                            {%>


                                                                                                                                        <div id="displayMsg_error" class="ddm_Display_Error_msg" >'User Level &amp; Function Mapping' Modification Approval Failed.- <span class="ddm_error"><%=msg%></span></div>
                                                                                                                                            <%                                                                                            }
                                                                                                                                            %>
                                                                                                                                ...
                                                                                                                                <tr>
                                                                                                                                    <td align="center" valign="middle">
                                                                                                                                        ...
                                                                                                                                        <table border="0" cellspacing="1" cellpadding="5" class="ddm_table_boder" bgcolor="#FFFFFF">
                                                                                                                                            ...
                                                                                                                                            <tr>
                                                                                                                                                <td align="center" valign="middle" class="ddm_tbl_header_text_horizontal">&nbsp;</td>
                                                                                                                                            ...
                                                                                                                                            <tr>
                                                                                                                                                ...
                                                                                                                                                <td align="left" valign="middle" class="ddm_tbl_common_text"><input type="hidden" name="hdnUserLevel" id="hdnUserLevel" class="ddm_success" value="<%=userLevelID%>" /></td>
                                                                                                                                            </tr>
                                                                                                                                            <tr>
                                                                                                                                            ...
                                                                                                                                            <tr>
                                                                                                                                                ...
                                                                                                                                                <%
                                                                                                                                                    ...
                                                                                                                                                    if (ulfm.getStatusModify() == null)
                                                                                                                                                    {
                                                                                                                                                        statModify = "N/A";
                                                                                                                                                    }
                                                                                                                                                    else if (ulfm.getStatusModify().equals(DDM_Constants.status_active))
                                                                                                                                                    {
                                                                                                                                                        statModify = "Active";
                                                                                                                                                    }
                                                                                                                                                    else if (ulfm.getStatusModify().equals(DDM_Constants.status_deactive))
                                                                                                                                                    {
                                                                                                                                                        statModify = "Inactive";
                                                                                                                                                    }
                                                                                                                                                    else
