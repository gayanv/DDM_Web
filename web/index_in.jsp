    ...
    if (isAuhenticated == null || isAuhenticated.equals("null"))
    {
        ...
        else
        {
            ...
            else
            {
                ...
                boolean isAuth = DAOFactory.getUserDAO().isAuthorized(new User(userName, password, DDM_Constants.status_active));
...
//                        if (user.getIsCurrentlyLoggedIn().equals(DDM_Constants.status_yes))
//                        {
//                            //DAOFactory.getUserDAO().setUserStatus(userName, DDM_Constants.status_expired, false);
//                            DAOFactory.getLogDAO().addLog(new Log(DDM_Constants.log_type_user_account_expired, "| Username - " + userName + " | Status - Account Expired " + " |"));
//                            
//                            userTypeDesc = user.getUserLevelDesc();
//
//                            session.setAttribute("session_userName", userName);
